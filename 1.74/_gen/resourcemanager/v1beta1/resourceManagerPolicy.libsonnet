{
  ...
  spec: {
    ...
    booleanPolicy: {
      ...
      withEnforced(enforced): { spec+: { booleanPolicy+: { enforced: enforced } } },
    },
    '#folderRef':: d.obj(help='"The folder on which to configure the constraint. Only one of\\nprojectRef, folderRef, or organizationRef may be specified."'),
    folderRef: {
      '#withExternal':: d.fn(help='"The name of a Folder."', args=[d.arg(name='external', type=d.T.string)]),
    ...
    listPolicy: {
      ...
      allow: {
        ...
        withAll(all): { spec+: { listPolicy+: { allow+: { all: all } } } },
        ...
        withValues(values): { spec+: { listPolicy+: { allow+: { values: if std.isArray(v=values) then values else [values] } } } },
        ...
        withValuesMixin(values): { spec+: { listPolicy+: { allow+: { values+: if std.isArray(v=values) then values else [values] } } } },
      },
      '#deny':: d.obj(help='"One or the other must be set."'),
      deny: {
        '#withAll':: d.fn(help='"The policy allows or denies all values."', args=[d.arg(name='all', type=d.T.boolean)]),
        withAll(all): { spec+: { listPolicy+: { deny+: { all: all } } } },
        '#withValues':: d.fn(help='"The policy can define specific values that are allowed or denied."', args=[d.arg(name='values', type=d.T.array)]),
        withValues(values): { spec+: { listPolicy+: { deny+: { values: if std.isArray(v=values) then values else [values] } } } },
        '#withValuesMixin':: d.fn(help='"The policy can define specific values that are allowed or denied."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='values', type=d.T.array)]),
        withValuesMixin(values): { spec+: { listPolicy+: { deny+: { values+: if std.isArray(v=values) then values else [values] } } } },
      },
      ...
      withInheritFromParent(inheritFromParent): { spec+: { listPolicy+: { inheritFromParent: inheritFromParent } } },
      ...
      withSuggestedValue(suggestedValue): { spec+: { listPolicy+: { suggestedValue: suggestedValue } } },
    },
    '#organizationRef':: d.obj(help='"The organization on which to configure the constraint. Only one of\\nprojectRef, folderRef, or organizationRef may be specified."'),
    organizationRef: {
    ...
    '#projectRef':: d.obj(help='"The project on which to configure the constraint. Only one of\\nprojectRef, folderRef, or organizationRef may be specified."'),
    projectRef: {
    ...
    restorePolicy: {
      ...
      withDefault(default): { spec+: { restorePolicy+: { default: default } } },
    },
    '#withConstraint':: d.fn(help='"Immutable. The name of the Constraint the Policy is configuring, for example, serviceuser.services."', args=[d.arg(name='constraint', type=d.T.string)]),
    withConstraint(constraint): { spec+: { constraint: constraint } },
