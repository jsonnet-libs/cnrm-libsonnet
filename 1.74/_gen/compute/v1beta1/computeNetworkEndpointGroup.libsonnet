{
  ...
  spec: {
    ...
    '#withNetworkEndpointType':: d.fn(help='"Immutable. Type of network endpoints in this network endpoint group. Default value: \\"GCE_VM_IP_PORT\\" Possible values: [\\"GCE_VM_IP_PORT\\"]."', args=[d.arg(name='networkEndpointType', type=d.T.string)]),
