{
  ...
  spec: {
    ...
    disk: {
      ...
      resourcePolicies: {
        '#withExternal':: d.fn(help='"The selfLink of a ComputeResourcePolicy."', args=[d.arg(name='external', type=d.T.string)]),
      ...
      sourceDiskRef: {
        '#withExternal':: d.fn(help='"The name of a ComputeDisk."', args=[d.arg(name='external', type=d.T.string)]),
