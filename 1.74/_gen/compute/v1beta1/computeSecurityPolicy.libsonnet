{
  ...
  spec: {
    ...
    rule: {
      ...
      '#withAction':: d.fn(help='"Action to take when match matches the request. Valid values:   \\"allow\\" : allow access to target, \\"deny(status)\\" : deny access to target, returns the HTTP response code specified (valid values are 403, 404 and 502)."', args=[d.arg(name='action', type=d.T.string)]),
