{
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#certificate':: d.obj(help='"Immutable. The certificate in PEM format.\\nThe certificate chain must be no greater than 5 certs long.\\nThe chain must include at least one intermediate cert."'),
    certificate: {
      ...
      valueFrom: {
        ...
        secretKeyRef: {
          ...
          withKey(key): { spec+: { certificate+: { valueFrom+: { secretKeyRef+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the Secret to extract a value from."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { certificate+: { valueFrom+: { secretKeyRef+: { name: name } } } } },
        },
      },
      '#withValue':: d.fn(help="\"Value of the field. Cannot be used if 'valueFrom' is specified.\"", args=[d.arg(name='value', type=d.T.string)]),
      withValue(value): { spec+: { certificate+: { value: value } } },
    },
    '#privateKey':: d.obj(help='"Immutable. The write-only private key in PEM format."'),
    privateKey: {
      '#valueFrom':: d.obj(help="\"Source for the field's value. Cannot be used if 'value' is specified.\""),
      valueFrom: {
        '#secretKeyRef':: d.obj(help="\"Reference to a value with the given key in the given Secret in the resource's namespace.\""),
        secretKeyRef: {
          '#withKey':: d.fn(help='"Key that identifies the value to be extracted."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { privateKey+: { valueFrom+: { secretKeyRef+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the Secret to extract a value from."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { privateKey+: { valueFrom+: { secretKeyRef+: { name: name } } } } },
        },
      },
      '#withValue':: d.fn(help="\"Value of the field. Cannot be used if 'valueFrom' is specified.\"", args=[d.arg(name='value', type=d.T.string)]),
      withValue(value): { spec+: { privateKey+: { value: value } } },
    },
    ...
    '#withLocation':: d.fn(help='"Location represents the geographical location of the ComputeSSLCertificate. Specify a region name or \\"global\\" for global resources. Reference: GCP definition of regions/zones (https://cloud.google.com/compute/docs/regions-zones/)"', args=[d.arg(name='location', type=d.T.string)]),
