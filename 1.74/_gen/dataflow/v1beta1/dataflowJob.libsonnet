{
  ...
  spec: {
    ...
    '#withParameters':: d.fn(help='"Key/Value pairs to be passed to the Dataflow job (as used in the template)."', args=[d.arg(name='parameters', type=d.T.any)]),
    ...
    '#withTransformNameMapping':: d.fn(help='"Only applicable when updating a pipeline. Map of transform name prefixes of the job to be replaced with the corresponding name prefixes of the new job."', args=[d.arg(name='transformNameMapping', type=d.T.any)]),
