{
  ...
  spec: {
    ...
    build: {
      ...
      availableSecrets: {
        ...
        secretManager: {
          ...
          versionRef: {
            '#withExternal':: d.fn(help='"The name of a SecretManagerSecretVersion."', args=[d.arg(name='external', type=d.T.string)]),
      ...
      logsBucketRef: {
        '#withExternal':: d.fn(help='"The url of a StorageBucket."', args=[d.arg(name='external', type=d.T.string)]),
      ...
      source: {
        ...
        repoSource: {
          ...
          repoRef: {
            '#withExternal':: d.fn(help='"The name of a SourceRepoRepository."', args=[d.arg(name='external', type=d.T.string)]),
    ...
    serviceAccountRef: {
      '#withExternal':: d.fn(help='"A string of the format \\"projects/{{project}}/serviceAccounts/{{value}}\\", where {{value}} is the email of an IAMServiceAccount."', args=[d.arg(name='external', type=d.T.string)]),
    ...
    webhookConfig: {
      ...
      secretRef: {
        '#withExternal':: d.fn(help='"The name of a SecretManagerSecret."', args=[d.arg(name='external', type=d.T.string)]),
