{
  ...
  spec: {
    ...
    '#networks':: d.obj(help='"VPC networks to which the instance is connected. For this version, only a single network is supported."'),
    networks: {
      ...
      '#withIpAddresses':: d.fn(help='"Output only. IPv4 addresses in the format `{octet1}.{octet2}.{octet3}.{octet4}` or IPv6 addresses in the format `{block1}:{block2}:{block3}:{block4}:{block5}:{block6}:{block7}:{block8}`."', args=[d.arg(name='ipAddresses', type=d.T.array)]),
      withIpAddresses(ipAddresses): { ipAddresses: if std.isArray(v=ipAddresses) then ipAddresses else [ipAddresses] },
      '#withIpAddressesMixin':: d.fn(help='"Output only. IPv4 addresses in the format `{octet1}.{octet2}.{octet3}.{octet4}` or IPv6 addresses in the format `{block1}:{block2}:{block3}:{block4}:{block5}:{block6}:{block7}:{block8}`."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipAddresses', type=d.T.array)]),
      withIpAddressesMixin(ipAddresses): { ipAddresses+: if std.isArray(v=ipAddresses) then ipAddresses else [ipAddresses] },
      '#withModes':: d.fn(help='"Internet protocol versions for which the instance has IP addresses assigned. For this version, only MODE_IPV4 is supported."', args=[d.arg(name='modes', type=d.T.array)]),
      withModes(modes): { modes: if std.isArray(v=modes) then modes else [modes] },
      '#withModesMixin':: d.fn(help='"Internet protocol versions for which the instance has IP addresses assigned. For this version, only MODE_IPV4 is supported."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='modes', type=d.T.array)]),
      withModesMixin(modes): { modes+: if std.isArray(v=modes) then modes else [modes] },
      '#withReservedIPRange':: d.fn(help="\"A /29 CIDR block in one of the [internal IP address ranges](https://www.arin.net/reference/research/statistics/address_filters/) that identifies the range of IP addresses reserved for this instance. For example, 10.0.0.0/29 or 192.168.0.0/29. The range you specify can't overlap with either existing subnets or assigned IP address ranges for other Cloud Filestore instances in the selected VPC network.\"", args=[d.arg(name='reservedIPRange', type=d.T.string)]),
    ...
    '#withNetworks':: d.fn(help='"VPC networks to which the instance is connected. For this version, only a single network is supported."', args=[d.arg(name='networks', type=d.T.array)]),
    withNetworks(networks): { spec+: { networks: if std.isArray(v=networks) then networks else [networks] } },
    '#withNetworksMixin':: d.fn(help='"VPC networks to which the instance is connected. For this version, only a single network is supported."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='networks', type=d.T.array)]),
    ...
    '#withTier':: d.fn(help='"The service tier of the instance. Possible values: TIER_UNSPECIFIED, STANDARD, PREMIUM, BASIC_HDD, BASIC_SSD, HIGH_SCALE_SSD"', args=[d.arg(name='tier', type=d.T.string)]),
