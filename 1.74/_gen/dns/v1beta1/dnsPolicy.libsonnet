{
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#alternativeNameServerConfig':: d.obj(help='"Sets an alternative name server for the associated networks.\\nWhen specified, all DNS queries are forwarded to a name server that you choose.\\nNames such as .internal are not available when an alternative name server is specified."'),
    alternativeNameServerConfig: {
      '#targetNameServers':: d.obj(help='"Sets an alternative name server for the associated networks. When specified,\\nall DNS queries are forwarded to a name server that you choose. Names such as .internal\\nare not available when an alternative name server is specified."'),
      targetNameServers: {
      ...
      '#withTargetNameServers':: d.fn(help='"Sets an alternative name server for the associated networks. When specified,\\nall DNS queries are forwarded to a name server that you choose. Names such as .internal\\nare not available when an alternative name server is specified."', args=[d.arg(name='targetNameServers', type=d.T.array)]),
      withTargetNameServers(targetNameServers): { spec+: { alternativeNameServerConfig+: { targetNameServers: if std.isArray(v=targetNameServers) then targetNameServers else [targetNameServers] } } },
      '#withTargetNameServersMixin':: d.fn(help='"Sets an alternative name server for the associated networks. When specified,\\nall DNS queries are forwarded to a name server that you choose. Names such as .internal\\nare not available when an alternative name server is specified."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='targetNameServers', type=d.T.array)]),
      withTargetNameServersMixin(targetNameServers): { spec+: { alternativeNameServerConfig+: { targetNameServers+: if std.isArray(v=targetNameServers) then targetNameServers else [targetNameServers] } } },
    },
    ...
    '#withEnableInboundForwarding':: d.fn(help='"Allows networks bound to this policy to receive DNS queries sent\\nby VMs or applications over VPN connections. When enabled, a\\nvirtual IP address will be allocated from each of the sub-networks\\nthat are bound to this policy."', args=[d.arg(name='enableInboundForwarding', type=d.T.boolean)]),
    withEnableInboundForwarding(enableInboundForwarding): { spec+: { enableInboundForwarding: enableInboundForwarding } },
    '#withEnableLogging':: d.fn(help='"Controls whether logging is enabled for the networks bound to this policy.\\nDefaults to no logging if not set."', args=[d.arg(name='enableLogging', type=d.T.boolean)]),
    withEnableLogging(enableLogging): { spec+: { enableLogging: enableLogging } },
    '#withNetworks':: d.fn(help='"List of network names specifying networks to which this policy is applied."', args=[d.arg(name='networks', type=d.T.array)]),
    withNetworks(networks): { spec+: { networks: if std.isArray(v=networks) then networks else [networks] } },
    '#withNetworksMixin':: d.fn(help='"List of network names specifying networks to which this policy is applied."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='networks', type=d.T.array)]),
