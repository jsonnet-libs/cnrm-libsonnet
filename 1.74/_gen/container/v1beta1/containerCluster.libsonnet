  ...
  spec: {
    ...
    notificationConfig: {
      ...
      pubsub: {
        ...
        topicRef: {
          '#withExternal':: d.fn(help='"A string of the format \\"projects/{{project}}/topics/{{value}}\\", where {{value}} is the name of a PubSubTopic."', args=[d.arg(name='external', type=d.T.string)]),
