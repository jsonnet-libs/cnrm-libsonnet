---
permalink: /1.74/memcache/v1beta1/memcacheInstance/
---
...
"A string of the format \"projects/{{project}}/global/networks/{{value}}\", where {{value}} is the name of a ComputeNetwork."
