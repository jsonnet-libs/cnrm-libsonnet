---
permalink: /1.74/bigtable/v1beta1/bigtableGCPolicy/
---
...
* [`obj spec`](#obj-spec)
  * [`fn withColumnFamily(columnFamily)`](#fn-specwithcolumnfamily)
  * [`fn withMaxAge(maxAge)`](#fn-specwithmaxage)
  * [`fn withMaxAgeMixin(maxAge)`](#fn-specwithmaxagemixin)
  * [`fn withMaxVersion(maxVersion)`](#fn-specwithmaxversion)
  * [`fn withMaxVersionMixin(maxVersion)`](#fn-specwithmaxversionmixin)
  ...
  * [`obj spec.maxAge`](#obj-specmaxage)
    * [`fn withDays(days)`](#fn-specmaxagewithdays)
    * [`fn withDuration(duration)`](#fn-specmaxagewithduration)
  * [`obj spec.maxVersion`](#obj-specmaxversion)
    * [`fn withNumber(number)`](#fn-specmaxversionwithnumber)
  * [`obj spec.tableRef`](#obj-spectableref)
    * [`fn withExternal(external)`](#fn-spectablerefwithexternal)
    * [`fn withName(name)`](#fn-spectablerefwithname)
    * [`fn withNamespace(namespace)`](#fn-spectablerefwithnamespace)
...
"The name of a BigtableInstance."
...
### fn spec.tableRef.withExternal

```ts
withExternal(external)
```

"The name of a BigtableTable."

### fn spec.tableRef.withName
...
### fn spec.tableRef.withNamespace
