---
permalink: /1.74/logging/v1beta1/loggingLogSink/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.exclusions`](#obj-specexclusions)
...
"A string of the format \"bigquery.googleapis.com/projects/{{project}}/datasets/{{value}}\", where {{value}} is the name of a BigQueryDataset."
...
"A string of the format \"pubsub.googleapis.com/projects/{{project}}/topics/{{value}}\", where {{value}} is the name of a PubSubTopic."
...
"A string of the format \"storage.googleapis.com/{{value}}\", where {{value}} is the name of a StorageBucket."
