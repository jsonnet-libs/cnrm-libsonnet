---
permalink: /1.130/workstations/v1alpha1/workstationCluster/
---

# workstations.v1alpha1.workstationCluster
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.annotations`](#obj-specannotations)
    * [`fn withKey(key)`](#fn-specannotationswithkey)
    * [`fn withValue(value)`](#fn-specannotationswithvalue)
  ...
  * [`obj spec.privateClusterConfig`](#obj-specprivateclusterconfig)
    * [`fn withAllowedProjects(allowedProjects)`](#fn-specprivateclusterconfigwithallowedprojects)
    * [`fn withAllowedProjectsMixin(allowedProjects)`](#fn-specprivateclusterconfigwithallowedprojectsmixin)
    * [`fn withEnablePrivateEndpoint(enablePrivateEndpoint)`](#fn-specprivateclusterconfigwithenableprivateendpoint)
    * [`obj spec.privateClusterConfig.allowedProjects`](#obj-specprivateclusterconfigallowedprojects)
      * [`fn withExternal(external)`](#fn-specprivateclusterconfigallowedprojectswithexternal)
      * [`fn withKind(kind)`](#fn-specprivateclusterconfigallowedprojectswithkind)
      * [`fn withName(name)`](#fn-specprivateclusterconfigallowedprojectswithname)
      * [`fn withNamespace(namespace)`](#fn-specprivateclusterconfigallowedprojectswithnamespace)
...
new returns an instance of WorkstationCluster
...
## obj spec.annotations

"Optional. Client-specified annotations."

### fn spec.annotations.withKey
...
### fn spec.privateClusterConfig.withAllowedProjects

```ts
withAllowedProjects(allowedProjects)
```

"Optional. Additional projects that are allowed to attach to the workstation cluster's service attachment. By default, the workstation cluster's project and the VPC host project (if different) are allowed."

### fn spec.privateClusterConfig.withAllowedProjectsMixin

```ts
withAllowedProjectsMixin(allowedProjects)
```
...
### fn spec.privateClusterConfig.allowedProjects.withExternal
...
### fn spec.privateClusterConfig.allowedProjects.withKind
...
### fn spec.privateClusterConfig.allowedProjects.withName
...
### fn spec.privateClusterConfig.allowedProjects.withNamespace
