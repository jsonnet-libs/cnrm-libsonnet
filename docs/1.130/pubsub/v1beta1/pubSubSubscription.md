---
permalink: /1.130/pubsub/v1beta1/pubSubSubscription/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.cloudStorageConfig`](#obj-speccloudstorageconfig)
    * [`fn withFilenamePrefix(filenamePrefix)`](#fn-speccloudstorageconfigwithfilenameprefix)
    * [`fn withFilenameSuffix(filenameSuffix)`](#fn-speccloudstorageconfigwithfilenamesuffix)
    * [`fn withMaxBytes(maxBytes)`](#fn-speccloudstorageconfigwithmaxbytes)
    * [`fn withMaxDuration(maxDuration)`](#fn-speccloudstorageconfigwithmaxduration)
    * [`fn withState(state)`](#fn-speccloudstorageconfigwithstate)
    * [`obj spec.cloudStorageConfig.avroConfig`](#obj-speccloudstorageconfigavroconfig)
      * [`fn withWriteMetadata(writeMetadata)`](#fn-speccloudstorageconfigavroconfigwithwritemetadata)
    * [`obj spec.cloudStorageConfig.bucketRef`](#obj-speccloudstorageconfigbucketref)
      * [`fn withExternal(external)`](#fn-speccloudstorageconfigbucketrefwithexternal)
      * [`fn withName(name)`](#fn-speccloudstorageconfigbucketrefwithname)
      * [`fn withNamespace(namespace)`](#fn-speccloudstorageconfigbucketrefwithnamespace)
  ...
  * [`obj spec.pushConfig`](#obj-specpushconfig)
    ...
    * [`obj spec.pushConfig.noWrapper`](#obj-specpushconfignowrapper)
      * [`fn withWriteMetadata(writeMetadata)`](#fn-specpushconfignowrapperwithwritemetadata)
...
### fn spec.bigqueryConfig.withUseTopicSchema
...
## obj spec.cloudStorageConfig

"If delivery to Cloud Storage is used with this subscription, this field is used to configure it.\nEither pushConfig, bigQueryConfig or cloudStorageConfig can be set, but not combined.\nIf all three are empty, then the subscriber will pull and ack messages using API methods."

### fn spec.cloudStorageConfig.withFilenamePrefix
...
### fn spec.cloudStorageConfig.withFilenameSuffix
...
### fn spec.cloudStorageConfig.withMaxBytes
...
### fn spec.cloudStorageConfig.withMaxDuration
...
### fn spec.cloudStorageConfig.withState
...
## obj spec.cloudStorageConfig.avroConfig

"If set, message data will be written to Cloud Storage in Avro format."

### fn spec.cloudStorageConfig.avroConfig.withWriteMetadata
...
## obj spec.cloudStorageConfig.bucketRef

"User-provided name for the Cloud Storage bucket. The bucket must be created by the user. The bucket name must be without any prefix like \"gs://\"."

### fn spec.cloudStorageConfig.bucketRef.withExternal
...
### fn spec.cloudStorageConfig.bucketRef.withName
...
### fn spec.cloudStorageConfig.bucketRef.withNamespace
...
## obj spec.pushConfig.noWrapper

"When set, the payload to the push endpoint is not wrapped.Sets the\n'data' field as the HTTP body for delivery."

### fn spec.pushConfig.noWrapper.withWriteMetadata
