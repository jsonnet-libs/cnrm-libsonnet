---
permalink: /1.130/storagetransfer/v1beta1/storageTransferJob/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.transferSpec`](#obj-spectransferspec)
    * [`fn withSinkAgentPoolName(sinkAgentPoolName)`](#fn-spectransferspecwithsinkagentpoolname)
    * [`fn withSourceAgentPoolName(sourceAgentPoolName)`](#fn-spectransferspecwithsourceagentpoolname)
    * [`obj spec.transferSpec.awsS3DataSource`](#obj-spectransferspecawss3datasource)
      ...
      * [`fn withPath(path)`](#fn-spectransferspecawss3datasourcewithpath)
    ...
    * [`obj spec.transferSpec.objectConditions`](#obj-spectransferspecobjectconditions)
      ...
      * [`fn withLastModifiedBefore(lastModifiedBefore)`](#fn-spectransferspecobjectconditionswithlastmodifiedbefore)
      * [`fn withLastModifiedSince(lastModifiedSince)`](#fn-spectransferspecobjectconditionswithlastmodifiedsince)
...
### fn spec.transferSpec.withSinkAgentPoolName

```ts
withSinkAgentPoolName(sinkAgentPoolName)
```

"Immutable. Specifies the agent pool name associated with the posix data source. When unspecified, the default name is used."

### fn spec.transferSpec.withSourceAgentPoolName

```ts
withSourceAgentPoolName(sourceAgentPoolName)
```
...
### fn spec.transferSpec.awsS3DataSource.withPath
...
### fn spec.transferSpec.objectConditions.withLastModifiedBefore

```ts
withLastModifiedBefore(lastModifiedBefore)
```

"If specified, only objects with a \"last modification time\" before this timestamp and objects that don't have a \"last modification time\" are transferred. A timestamp in RFC3339 UTC \"Zulu\" format, with nanosecond resolution and up to nine fractional digits. Examples: \"2014-10-02T15:01:23Z\" and \"2014-10-02T15:01:23.045123456Z\"."

### fn spec.transferSpec.objectConditions.withLastModifiedSince

```ts
withLastModifiedSince(lastModifiedSince)
```
