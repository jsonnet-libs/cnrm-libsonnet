---
permalink: /1.130/oslogin/v1alpha1/osLoginSSHPublicKey/
---

# oslogin.v1alpha1.osLoginSSHPublicKey
...
* [`obj spec`](#obj-spec)
  * [`fn withExpirationTimeUsec(expirationTimeUsec)`](#fn-specwithexpirationtimeusec)
...
new returns an instance of OSLoginSSHPublicKey
...
### fn spec.withExpirationTimeUsec

```ts
withExpirationTimeUsec(expirationTimeUsec)
```
