---
permalink: /1.130/secretmanager/v1beta1/secretManagerSecret/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withVersionAliases(versionAliases)`](#fn-specwithversionaliases)
  * [`fn withVersionAliasesMixin(versionAliases)`](#fn-specwithversionaliasesmixin)
  * [`obj spec.replication`](#obj-specreplication)
    * [`fn withAutomatic(automatic)`](#fn-specreplicationwithautomatic)
    * [`obj spec.replication.auto`](#obj-specreplicationauto)
      * [`obj spec.replication.auto.customerManagedEncryption`](#obj-specreplicationautocustomermanagedencryption)
        * [`obj spec.replication.auto.customerManagedEncryption.kmsKeyRef`](#obj-specreplicationautocustomermanagedencryptionkmskeyref)
          * [`fn withExternal(external)`](#fn-specreplicationautocustomermanagedencryptionkmskeyrefwithexternal)
          * [`fn withName(name)`](#fn-specreplicationautocustomermanagedencryptionkmskeyrefwithname)
          * [`fn withNamespace(namespace)`](#fn-specreplicationautocustomermanagedencryptionkmskeyrefwithnamespace)
  ...
  * [`obj spec.topics`](#obj-spectopics)
    * [`obj spec.topics.topicRef`](#obj-spectopicstopicref)
      ...
      * [`fn withName(name)`](#fn-spectopicstopicrefwithname)
