---
permalink: /1.130/compute/v1beta1/computeExternalVPNGateway/
---
...
### fn spec.withInterfaceMixin

```ts
withInterfaceMixin(interface)
```
...
### fn spec.withRedundancyType

```ts
withRedundancyType(redundancyType)
```
