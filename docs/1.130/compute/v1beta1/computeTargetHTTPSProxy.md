---
permalink: /1.130/compute/v1beta1/computeTargetHTTPSProxy/
---
...
* [`obj spec`](#obj-spec)
  * [`fn withCertificateManagerCertificates(certificateManagerCertificates)`](#fn-specwithcertificatemanagercertificates)
  * [`fn withCertificateManagerCertificatesMixin(certificateManagerCertificates)`](#fn-specwithcertificatemanagercertificatesmixin)
  * [`fn withDescription(description)`](#fn-specwithdescription)
  * [`fn withHttpKeepAliveTimeoutSec(httpKeepAliveTimeoutSec)`](#fn-specwithhttpkeepalivetimeoutsec)
  ...
  * [`obj spec.certificateManagerCertificates`](#obj-speccertificatemanagercertificates)
    * [`fn withExternal(external)`](#fn-speccertificatemanagercertificateswithexternal)
    * [`fn withName(name)`](#fn-speccertificatemanagercertificateswithname)
    * [`fn withNamespace(namespace)`](#fn-speccertificatemanagercertificateswithnamespace)
...
### fn spec.withCertificateManagerCertificates
...
### fn spec.withCertificateManagerCertificatesMixin
...
### fn spec.withHttpKeepAliveTimeoutSec

```ts
withHttpKeepAliveTimeoutSec(httpKeepAliveTimeoutSec)
```
...
## obj spec.certificateManagerCertificates



### fn spec.certificateManagerCertificates.withExternal

```ts
withExternal(external)
```

"Allowed value: string of the format `projects/{{project}}/locations/global/certificates/{{value}}`, where {{value}} is the `name` field of a `CertificateManagerCertificate` resource."

### fn spec.certificateManagerCertificates.withName
...
### fn spec.certificateManagerCertificates.withNamespace
