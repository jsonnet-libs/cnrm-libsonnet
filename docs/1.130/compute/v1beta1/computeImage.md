---
permalink: /1.130/compute/v1beta1/computeImage/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.imageEncryptionKey`](#obj-specimageencryptionkey)
    * [`obj spec.imageEncryptionKey.kmsKeySelfLinkRef`](#obj-specimageencryptionkeykmskeyselflinkref)
      * [`fn withExternal(external)`](#fn-specimageencryptionkeykmskeyselflinkrefwithexternal)
      * [`fn withName(name)`](#fn-specimageencryptionkeykmskeyselflinkrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specimageencryptionkeykmskeyselflinkrefwithnamespace)
    * [`obj spec.imageEncryptionKey.kmsKeyServiceAccountRef`](#obj-specimageencryptionkeykmskeyserviceaccountref)
      * [`fn withExternal(external)`](#fn-specimageencryptionkeykmskeyserviceaccountrefwithexternal)
      * [`fn withName(name)`](#fn-specimageencryptionkeykmskeyserviceaccountrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specimageencryptionkeykmskeyserviceaccountrefwithnamespace)
...
## obj spec.imageEncryptionKey

"Immutable. Encrypts the image using a customer-supplied encryption key.\n\nAfter you encrypt an image with a customer-supplied key, you must\nprovide the same key if you use the image later (e.g. to create a\ndisk from the image)."

## obj spec.imageEncryptionKey.kmsKeySelfLinkRef

"The self link of the encryption key that is stored in Google Cloud\nKMS."

### fn spec.imageEncryptionKey.kmsKeySelfLinkRef.withExternal
...
### fn spec.imageEncryptionKey.kmsKeySelfLinkRef.withName
...
### fn spec.imageEncryptionKey.kmsKeySelfLinkRef.withNamespace
...
## obj spec.imageEncryptionKey.kmsKeyServiceAccountRef

"The service account being used for the encryption request for the\ngiven KMS key. If absent, the Compute Engine default service account\nis used."

### fn spec.imageEncryptionKey.kmsKeyServiceAccountRef.withExternal
...
### fn spec.imageEncryptionKey.kmsKeyServiceAccountRef.withName
...
### fn spec.imageEncryptionKey.kmsKeyServiceAccountRef.withNamespace
