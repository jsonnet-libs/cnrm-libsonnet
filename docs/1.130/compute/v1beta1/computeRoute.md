---
permalink: /1.130/compute/v1beta1/computeRoute/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withDestRange(destRange)`](#fn-specwithdestrange)
  * [`fn withNextHopGateway(nextHopGateway)`](#fn-specwithnexthopgateway)
  * [`fn withNextHopIp(nextHopIp)`](#fn-specwithnexthopip)
  ...
  * [`obj spec.nextHopILBRef`](#obj-specnexthopilbref)
    * [`fn withExternal(external)`](#fn-specnexthopilbrefwithexternal)
    * [`fn withName(name)`](#fn-specnexthopilbrefwithname)
    * [`fn withNamespace(namespace)`](#fn-specnexthopilbrefwithnamespace)
  * [`obj spec.nextHopInstanceRef`](#obj-specnexthopinstanceref)
    * [`fn withExternal(external)`](#fn-specnexthopinstancerefwithexternal)
    * [`fn withName(name)`](#fn-specnexthopinstancerefwithname)
    * [`fn withNamespace(namespace)`](#fn-specnexthopinstancerefwithnamespace)
  * [`obj spec.nextHopVPNTunnelRef`](#obj-specnexthopvpntunnelref)
    * [`fn withExternal(external)`](#fn-specnexthopvpntunnelrefwithexternal)
    * [`fn withName(name)`](#fn-specnexthopvpntunnelrefwithname)
    * [`fn withNamespace(namespace)`](#fn-specnexthopvpntunnelrefwithnamespace)
...
### fn spec.nextHopILBRef.withExternal
...
### fn spec.nextHopILBRef.withName
...
### fn spec.nextHopILBRef.withNamespace
...
## obj spec.nextHopInstanceRef

"Instance that should handle matching packets."

### fn spec.nextHopInstanceRef.withExternal
...
### fn spec.nextHopInstanceRef.withName
...
### fn spec.nextHopInstanceRef.withNamespace
...
## obj spec.nextHopVPNTunnelRef

"The ComputeVPNTunnel that should handle matching packets"

### fn spec.nextHopVPNTunnelRef.withExternal
...
### fn spec.nextHopVPNTunnelRef.withName
...
### fn spec.nextHopVPNTunnelRef.withNamespace
