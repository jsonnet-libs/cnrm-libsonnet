---
permalink: /1.130/compute/v1beta1/computeAddress/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withIpv6EndpointType(ipv6EndpointType)`](#fn-specwithipv6endpointtype)
...
### fn spec.withIpv6EndpointType

```ts
withIpv6EndpointType(ipv6EndpointType)
```
