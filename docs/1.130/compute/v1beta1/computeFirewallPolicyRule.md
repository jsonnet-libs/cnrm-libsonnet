---
permalink: /1.130/compute/v1beta1/computeFirewallPolicyRule/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.targetResources`](#obj-spectargetresources)
    ...
    * [`fn withName(name)`](#fn-spectargetresourceswithname)
...
"A reference to an externally managed ComputeFirewallPolicy resource. Should be in the format `locations/global/firewallPolicies/<firewallPolicy>`."
