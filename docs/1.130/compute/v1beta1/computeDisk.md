---
permalink: /1.130/compute/v1beta1/computeDisk/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withEnableConfidentialCompute(enableConfidentialCompute)`](#fn-specwithenableconfidentialcompute)
  ...
  * [`fn withProvisionedThroughput(provisionedThroughput)`](#fn-specwithprovisionedthroughput)
  ...
  * [`obj spec.asyncPrimaryDisk`](#obj-specasyncprimarydisk)
    * [`obj spec.asyncPrimaryDisk.diskRef`](#obj-specasyncprimarydiskdiskref)
      * [`fn withExternal(external)`](#fn-specasyncprimarydiskdiskrefwithexternal)
      * [`fn withName(name)`](#fn-specasyncprimarydiskdiskrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specasyncprimarydiskdiskrefwithnamespace)
  * [`obj spec.diskEncryptionKey`](#obj-specdiskencryptionkey)
    ...
    * [`obj spec.diskEncryptionKey.rsaEncryptedKey`](#obj-specdiskencryptionkeyrsaencryptedkey)
      * [`fn withValue(value)`](#fn-specdiskencryptionkeyrsaencryptedkeywithvalue)
      * [`obj spec.diskEncryptionKey.rsaEncryptedKey.valueFrom`](#obj-specdiskencryptionkeyrsaencryptedkeyvaluefrom)
        * [`obj spec.diskEncryptionKey.rsaEncryptedKey.valueFrom.secretKeyRef`](#obj-specdiskencryptionkeyrsaencryptedkeyvaluefromsecretkeyref)
          * [`fn withKey(key)`](#fn-specdiskencryptionkeyrsaencryptedkeyvaluefromsecretkeyrefwithkey)
          * [`fn withName(name)`](#fn-specdiskencryptionkeyrsaencryptedkeyvaluefromsecretkeyrefwithname)
...
### fn spec.withEnableConfidentialCompute
...
### fn spec.withProvisionedThroughput
...
## obj spec.asyncPrimaryDisk

"Immutable. A nested object resource."

## obj spec.asyncPrimaryDisk.diskRef

"Immutable. Primary disk for asynchronous disk replication."

### fn spec.asyncPrimaryDisk.diskRef.withExternal
...
### fn spec.asyncPrimaryDisk.diskRef.withName
...
### fn spec.asyncPrimaryDisk.diskRef.withNamespace
...
## obj spec.diskEncryptionKey.rsaEncryptedKey

"Immutable. Specifies an RFC 4648 base64 encoded, RSA-wrapped 2048-bit\ncustomer-supplied encryption key to either encrypt or decrypt\nthis resource. You can provide either the rawKey or the rsaEncryptedKey."

### fn spec.diskEncryptionKey.rsaEncryptedKey.withValue
...
## obj spec.diskEncryptionKey.rsaEncryptedKey.valueFrom

"Source for the field's value. Cannot be used if 'value' is specified."

## obj spec.diskEncryptionKey.rsaEncryptedKey.valueFrom.secretKeyRef

"Reference to a value with the given key in the given Secret in the resource's namespace."

### fn spec.diskEncryptionKey.rsaEncryptedKey.valueFrom.secretKeyRef.withKey
...
### fn spec.diskEncryptionKey.rsaEncryptedKey.valueFrom.secretKeyRef.withName
