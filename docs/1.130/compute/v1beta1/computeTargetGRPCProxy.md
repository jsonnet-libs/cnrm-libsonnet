---
permalink: /1.130/compute/v1beta1/computeTargetGRPCProxy/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withValidateForProxyless(validateForProxyless)`](#fn-specwithvalidateforproxyless)
...
### fn spec.withValidateForProxyless

```ts
withValidateForProxyless(validateForProxyless)
```
