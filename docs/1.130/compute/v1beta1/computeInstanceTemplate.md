---
permalink: /1.130/compute/v1beta1/computeInstanceTemplate/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.disk`](#obj-specdisk)
    ...
    * [`fn withProvisionedIops(provisionedIops)`](#fn-specdiskwithprovisionediops)
    ...
    * [`obj spec.disk.sourceImageEncryptionKey`](#obj-specdisksourceimageencryptionkey)
      * [`obj spec.disk.sourceImageEncryptionKey.kmsKeySelfLinkRef`](#obj-specdisksourceimageencryptionkeykmskeyselflinkref)
        * [`fn withExternal(external)`](#fn-specdisksourceimageencryptionkeykmskeyselflinkrefwithexternal)
        * [`fn withName(name)`](#fn-specdisksourceimageencryptionkeykmskeyselflinkrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specdisksourceimageencryptionkeykmskeyselflinkrefwithnamespace)
      * [`obj spec.disk.sourceImageEncryptionKey.kmsKeyServiceAccountRef`](#obj-specdisksourceimageencryptionkeykmskeyserviceaccountref)
        * [`fn withExternal(external)`](#fn-specdisksourceimageencryptionkeykmskeyserviceaccountrefwithexternal)
        * [`fn withName(name)`](#fn-specdisksourceimageencryptionkeykmskeyserviceaccountrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specdisksourceimageencryptionkeykmskeyserviceaccountrefwithnamespace)
    ...
    * [`obj spec.disk.sourceSnapshotEncryptionKey`](#obj-specdisksourcesnapshotencryptionkey)
      * [`obj spec.disk.sourceSnapshotEncryptionKey.kmsKeySelfLinkRef`](#obj-specdisksourcesnapshotencryptionkeykmskeyselflinkref)
        * [`fn withExternal(external)`](#fn-specdisksourcesnapshotencryptionkeykmskeyselflinkrefwithexternal)
        * [`fn withName(name)`](#fn-specdisksourcesnapshotencryptionkeykmskeyselflinkrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specdisksourcesnapshotencryptionkeykmskeyselflinkrefwithnamespace)
      * [`obj spec.disk.sourceSnapshotEncryptionKey.kmsKeyServiceAccountRef`](#obj-specdisksourcesnapshotencryptionkeykmskeyserviceaccountref)
        * [`fn withExternal(external)`](#fn-specdisksourcesnapshotencryptionkeykmskeyserviceaccountrefwithexternal)
        * [`fn withName(name)`](#fn-specdisksourcesnapshotencryptionkeykmskeyserviceaccountrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specdisksourcesnapshotencryptionkeykmskeyserviceaccountrefwithnamespace)
    * [`obj spec.disk.sourceSnapshotRef`](#obj-specdisksourcesnapshotref)
      * [`fn withExternal(external)`](#fn-specdisksourcesnapshotrefwithexternal)
      * [`fn withName(name)`](#fn-specdisksourcesnapshotrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specdisksourcesnapshotrefwithnamespace)
  ...
  * [`obj spec.networkInterface`](#obj-specnetworkinterface)
    ...
    * [`fn withInternalIpv6PrefixLength(internalIpv6PrefixLength)`](#fn-specnetworkinterfacewithinternalipv6prefixlength)
    ...
    * [`fn withIpv6Address(ipv6Address)`](#fn-specnetworkinterfacewithipv6address)
    * [`fn withName(name)`](#fn-specnetworkinterfacewithname)
    * [`fn withNetworkAttachment(networkAttachment)`](#fn-specnetworkinterfacewithnetworkattachment)
    ...
    * [`obj spec.networkInterface.ipv6AccessConfig`](#obj-specnetworkinterfaceipv6accessconfig)
      ...
      * [`fn withName(name)`](#fn-specnetworkinterfaceipv6accessconfigwithname)
  ...
  * [`obj spec.scheduling`](#obj-specscheduling)
    ...
    * [`fn withLocalSsdRecoveryTimeout(localSsdRecoveryTimeout)`](#fn-specschedulingwithlocalssdrecoverytimeout)
    * [`fn withLocalSsdRecoveryTimeoutMixin(localSsdRecoveryTimeout)`](#fn-specschedulingwithlocalssdrecoverytimeoutmixin)
    * [`fn withMaintenanceInterval(maintenanceInterval)`](#fn-specschedulingwithmaintenanceinterval)
    ...
    * [`obj spec.scheduling.localSsdRecoveryTimeout`](#obj-specschedulinglocalssdrecoverytimeout)
      * [`fn withNanos(nanos)`](#fn-specschedulinglocalssdrecoverytimeoutwithnanos)
      * [`fn withSeconds(seconds)`](#fn-specschedulinglocalssdrecoverytimeoutwithseconds)
    * [`obj spec.scheduling.maxRunDuration`](#obj-specschedulingmaxrunduration)
      * [`fn withNanos(nanos)`](#fn-specschedulingmaxrundurationwithnanos)
      * [`fn withSeconds(seconds)`](#fn-specschedulingmaxrundurationwithseconds)
