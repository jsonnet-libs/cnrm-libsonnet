---
permalink: /1.130/firebasehosting/v1alpha1/firebaseHostingChannel/
---

# firebasehosting.v1alpha1.firebaseHostingChannel
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withRetainedReleaseCount(retainedReleaseCount)`](#fn-specwithretainedreleasecount)
  * [`fn withSiteId(siteId)`](#fn-specwithsiteid)
...
new returns an instance of FirebaseHostingChannel
...
### fn spec.withRetainedReleaseCount

```ts
withRetainedReleaseCount(retainedReleaseCount)
```
