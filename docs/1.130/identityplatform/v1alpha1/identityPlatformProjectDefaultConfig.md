---
permalink: /1.130/identityplatform/v1alpha1/identityPlatformProjectDefaultConfig/
---

# identityplatform.v1alpha1.identityPlatformProjectDefaultConfig
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.signIn`](#obj-specsignin)
    ...
    * [`fn withHashConfig(hashConfig)`](#fn-specsigninwithhashconfig)
    * [`fn withHashConfigMixin(hashConfig)`](#fn-specsigninwithhashconfigmixin)
    ...
    * [`obj spec.signIn.hashConfig`](#obj-specsigninhashconfig)
      * [`fn withAlgorithm(algorithm)`](#fn-specsigninhashconfigwithalgorithm)
      * [`fn withMemoryCost(memoryCost)`](#fn-specsigninhashconfigwithmemorycost)
      * [`fn withRounds(rounds)`](#fn-specsigninhashconfigwithrounds)
      * [`fn withSaltSeparator(saltSeparator)`](#fn-specsigninhashconfigwithsaltseparator)
      * [`fn withSignerKey(signerKey)`](#fn-specsigninhashconfigwithsignerkey)
...
new returns an instance of IdentityPlatformProjectDefaultConfig
...
### fn spec.signIn.withHashConfig

```ts
withHashConfig(hashConfig)
```

"Output only. Hash config information."

### fn spec.signIn.withHashConfigMixin

```ts
withHashConfigMixin(hashConfig)
```
...
## obj spec.signIn.hashConfig

"Output only. Hash config information."

### fn spec.signIn.hashConfig.withAlgorithm
...
### fn spec.signIn.hashConfig.withMemoryCost
...
### fn spec.signIn.hashConfig.withRounds
...
### fn spec.signIn.hashConfig.withSaltSeparator

```ts
withSaltSeparator(saltSeparator)
```

"Non-printable character to be inserted between the salt and plain text password in base64."

### fn spec.signIn.hashConfig.withSignerKey
