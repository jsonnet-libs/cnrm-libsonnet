---
permalink: /1.130/bigquery/v1beta1/bigQueryJob/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.load`](#obj-specload)
    ...
    * [`obj spec.load.parquetOptions`](#obj-specloadparquetoptions)
      * [`fn withEnableListInference(enableListInference)`](#fn-specloadparquetoptionswithenablelistinference)
      * [`fn withEnumAsString(enumAsString)`](#fn-specloadparquetoptionswithenumasstring)
...
## obj spec.load.parquetOptions

"Immutable. Parquet Options for load and make external tables."

### fn spec.load.parquetOptions.withEnableListInference
...
### fn spec.load.parquetOptions.withEnumAsString
