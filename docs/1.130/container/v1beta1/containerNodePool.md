---
permalink: /1.130/container/v1beta1/containerNodePool/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.autoscaling`](#obj-specautoscaling)
    * [`fn withLocationPolicy(locationPolicy)`](#fn-specautoscalingwithlocationpolicy)
    ...
    * [`fn withTotalMaxNodeCount(totalMaxNodeCount)`](#fn-specautoscalingwithtotalmaxnodecount)
    * [`fn withTotalMinNodeCount(totalMinNodeCount)`](#fn-specautoscalingwithtotalminnodecount)
  ...
  * [`obj spec.networkConfig`](#obj-specnetworkconfig)
    * [`fn withAdditionalNodeNetworkConfigs(additionalNodeNetworkConfigs)`](#fn-specnetworkconfigwithadditionalnodenetworkconfigs)
    * [`fn withAdditionalNodeNetworkConfigsMixin(additionalNodeNetworkConfigs)`](#fn-specnetworkconfigwithadditionalnodenetworkconfigsmixin)
    * [`fn withAdditionalPodNetworkConfigs(additionalPodNetworkConfigs)`](#fn-specnetworkconfigwithadditionalpodnetworkconfigs)
    * [`fn withAdditionalPodNetworkConfigsMixin(additionalPodNetworkConfigs)`](#fn-specnetworkconfigwithadditionalpodnetworkconfigsmixin)
    * [`fn withCreatePodRange(createPodRange)`](#fn-specnetworkconfigwithcreatepodrange)
    * [`fn withEnablePrivateNodes(enablePrivateNodes)`](#fn-specnetworkconfigwithenableprivatenodes)
    ...
    * [`obj spec.networkConfig.additionalNodeNetworkConfigs`](#obj-specnetworkconfigadditionalnodenetworkconfigs)
      * [`obj spec.networkConfig.additionalNodeNetworkConfigs.networkRef`](#obj-specnetworkconfigadditionalnodenetworkconfigsnetworkref)
        * [`fn withExternal(external)`](#fn-specnetworkconfigadditionalnodenetworkconfigsnetworkrefwithexternal)
        * [`fn withName(name)`](#fn-specnetworkconfigadditionalnodenetworkconfigsnetworkrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specnetworkconfigadditionalnodenetworkconfigsnetworkrefwithnamespace)
      * [`obj spec.networkConfig.additionalNodeNetworkConfigs.subnetworkRef`](#obj-specnetworkconfigadditionalnodenetworkconfigssubnetworkref)
        * [`fn withExternal(external)`](#fn-specnetworkconfigadditionalnodenetworkconfigssubnetworkrefwithexternal)
        * [`fn withName(name)`](#fn-specnetworkconfigadditionalnodenetworkconfigssubnetworkrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specnetworkconfigadditionalnodenetworkconfigssubnetworkrefwithnamespace)
    * [`obj spec.networkConfig.additionalPodNetworkConfigs`](#obj-specnetworkconfigadditionalpodnetworkconfigs)
      * [`fn withMaxPodsPerNode(maxPodsPerNode)`](#fn-specnetworkconfigadditionalpodnetworkconfigswithmaxpodspernode)
      * [`fn withSecondaryPodRange(secondaryPodRange)`](#fn-specnetworkconfigadditionalpodnetworkconfigswithsecondarypodrange)
      * [`obj spec.networkConfig.additionalPodNetworkConfigs.subnetworkRef`](#obj-specnetworkconfigadditionalpodnetworkconfigssubnetworkref)
        * [`fn withExternal(external)`](#fn-specnetworkconfigadditionalpodnetworkconfigssubnetworkrefwithexternal)
        * [`fn withName(name)`](#fn-specnetworkconfigadditionalpodnetworkconfigssubnetworkrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specnetworkconfigadditionalpodnetworkconfigssubnetworkrefwithnamespace)
    * [`obj spec.networkConfig.podCidrOverprovisionConfig`](#obj-specnetworkconfigpodcidroverprovisionconfig)
      * [`fn withDisabled(disabled)`](#fn-specnetworkconfigpodcidroverprovisionconfigwithdisabled)
  * [`obj spec.nodeConfig`](#obj-specnodeconfig)
    ...
    * [`obj spec.nodeConfig.advancedMachineFeatures`](#obj-specnodeconfigadvancedmachinefeatures)
      * [`fn withThreadsPerCore(threadsPerCore)`](#fn-specnodeconfigadvancedmachinefeatureswiththreadspercore)
    ...
    * [`obj spec.nodeConfig.confidentialNodes`](#obj-specnodeconfigconfidentialnodes)
      * [`fn withEnabled(enabled)`](#fn-specnodeconfigconfidentialnodeswithenabled)
    ...
    * [`obj spec.nodeConfig.ephemeralStorageLocalSsdConfig`](#obj-specnodeconfigephemeralstoragelocalssdconfig)
      * [`fn withLocalSsdCount(localSsdCount)`](#fn-specnodeconfigephemeralstoragelocalssdconfigwithlocalssdcount)
    * [`obj spec.nodeConfig.fastSocket`](#obj-specnodeconfigfastsocket)
      * [`fn withEnabled(enabled)`](#fn-specnodeconfigfastsocketwithenabled)
    ...
    * [`obj spec.nodeConfig.guestAccelerator`](#obj-specnodeconfigguestaccelerator)
      ...
      * [`obj spec.nodeConfig.guestAccelerator.gpuDriverInstallationConfig`](#obj-specnodeconfigguestacceleratorgpudriverinstallationconfig)
        * [`fn withGpuDriverVersion(gpuDriverVersion)`](#fn-specnodeconfigguestacceleratorgpudriverinstallationconfigwithgpudriverversion)
    ...
    * [`obj spec.nodeConfig.hostMaintenancePolicy`](#obj-specnodeconfighostmaintenancepolicy)
      * [`fn withMaintenanceInterval(maintenanceInterval)`](#fn-specnodeconfighostmaintenancepolicywithmaintenanceinterval)
    * [`obj spec.nodeConfig.kubeletConfig`](#obj-specnodeconfigkubeletconfig)
      ...
      * [`fn withPodPidsLimit(podPidsLimit)`](#fn-specnodeconfigkubeletconfigwithpodpidslimit)
    * [`obj spec.nodeConfig.linuxNodeConfig`](#obj-specnodeconfiglinuxnodeconfig)
      * [`fn withCgroupMode(cgroupMode)`](#fn-specnodeconfiglinuxnodeconfigwithcgroupmode)
    ...
    * [`obj spec.nodeConfig.localNvmeSsdBlockConfig`](#obj-specnodeconfiglocalnvmessdblockconfig)
      * [`fn withLocalSsdCount(localSsdCount)`](#fn-specnodeconfiglocalnvmessdblockconfigwithlocalssdcount)
    ...
    * [`obj spec.nodeConfig.soleTenantConfig`](#obj-specnodeconfigsoletenantconfig)
      * [`fn withNodeAffinity(nodeAffinity)`](#fn-specnodeconfigsoletenantconfigwithnodeaffinity)
      * [`fn withNodeAffinityMixin(nodeAffinity)`](#fn-specnodeconfigsoletenantconfigwithnodeaffinitymixin)
      * [`obj spec.nodeConfig.soleTenantConfig.nodeAffinity`](#obj-specnodeconfigsoletenantconfignodeaffinity)
        * [`fn withKey(key)`](#fn-specnodeconfigsoletenantconfignodeaffinitywithkey)
        * [`fn withOperator(operator)`](#fn-specnodeconfigsoletenantconfignodeaffinitywithoperator)
        * [`fn withValues(values)`](#fn-specnodeconfigsoletenantconfignodeaffinitywithvalues)
        * [`fn withValuesMixin(values)`](#fn-specnodeconfigsoletenantconfignodeaffinitywithvaluesmixin)
  ...
  * [`obj spec.placementPolicy`](#obj-specplacementpolicy)
    * [`fn withTpuTopology(tpuTopology)`](#fn-specplacementpolicywithtputopology)
    * [`fn withType(type)`](#fn-specplacementpolicywithtype)
    * [`obj spec.placementPolicy.policyNameRef`](#obj-specplacementpolicypolicynameref)
      * [`fn withExternal(external)`](#fn-specplacementpolicypolicynamerefwithexternal)
      * [`fn withName(name)`](#fn-specplacementpolicypolicynamerefwithname)
      * [`fn withNamespace(namespace)`](#fn-specplacementpolicypolicynamerefwithnamespace)
  * [`obj spec.upgradeSettings`](#obj-specupgradesettings)
    ...
    * [`fn withStrategy(strategy)`](#fn-specupgradesettingswithstrategy)
    * [`obj spec.upgradeSettings.blueGreenSettings`](#obj-specupgradesettingsbluegreensettings)
      * [`fn withNodePoolSoakDuration(nodePoolSoakDuration)`](#fn-specupgradesettingsbluegreensettingswithnodepoolsoakduration)
      * [`obj spec.upgradeSettings.blueGreenSettings.standardRolloutPolicy`](#obj-specupgradesettingsbluegreensettingsstandardrolloutpolicy)
        * [`fn withBatchNodeCount(batchNodeCount)`](#fn-specupgradesettingsbluegreensettingsstandardrolloutpolicywithbatchnodecount)
        * [`fn withBatchPercentage(batchPercentage)`](#fn-specupgradesettingsbluegreensettingsstandardrolloutpolicywithbatchpercentage)
        * [`fn withBatchSoakDuration(batchSoakDuration)`](#fn-specupgradesettingsbluegreensettingsstandardrolloutpolicywithbatchsoakduration)
...
### fn spec.autoscaling.withLocationPolicy
...
### fn spec.autoscaling.withTotalMaxNodeCount
...
### fn spec.autoscaling.withTotalMinNodeCount
...
### fn spec.networkConfig.withAdditionalNodeNetworkConfigs

```ts
withAdditionalNodeNetworkConfigs(additionalNodeNetworkConfigs)
```
...
### fn spec.networkConfig.withAdditionalNodeNetworkConfigsMixin

```ts
withAdditionalNodeNetworkConfigsMixin(additionalNodeNetworkConfigs)
```
...
### fn spec.networkConfig.withAdditionalPodNetworkConfigs

```ts
withAdditionalPodNetworkConfigs(additionalPodNetworkConfigs)
```
...
### fn spec.networkConfig.withAdditionalPodNetworkConfigsMixin

```ts
withAdditionalPodNetworkConfigsMixin(additionalPodNetworkConfigs)
```
...
### fn spec.networkConfig.withEnablePrivateNodes
...
## obj spec.networkConfig.additionalNodeNetworkConfigs

"Immutable. We specify the additional node networks for this node pool using this list. Each node network corresponds to an additional interface."

## obj spec.networkConfig.additionalNodeNetworkConfigs.networkRef

"Immutable. Name of the VPC where the additional interface belongs."

### fn spec.networkConfig.additionalNodeNetworkConfigs.networkRef.withExternal
...
### fn spec.networkConfig.additionalNodeNetworkConfigs.networkRef.withName
...
### fn spec.networkConfig.additionalNodeNetworkConfigs.networkRef.withNamespace
...
## obj spec.networkConfig.additionalNodeNetworkConfigs.subnetworkRef

"Immutable. Name of the subnetwork where the additional interface belongs."

### fn spec.networkConfig.additionalNodeNetworkConfigs.subnetworkRef.withExternal
...
### fn spec.networkConfig.additionalNodeNetworkConfigs.subnetworkRef.withName
...
### fn spec.networkConfig.additionalNodeNetworkConfigs.subnetworkRef.withNamespace
...
## obj spec.networkConfig.additionalPodNetworkConfigs

"Immutable. We specify the additional pod networks for this node pool using this list. Each pod network corresponds to an additional alias IP range for the node."

### fn spec.networkConfig.additionalPodNetworkConfigs.withMaxPodsPerNode
...
### fn spec.networkConfig.additionalPodNetworkConfigs.withSecondaryPodRange

```ts
withSecondaryPodRange(secondaryPodRange)
```

"Immutable. The name of the secondary range on the subnet which provides IP address for this pod range."

## obj spec.networkConfig.additionalPodNetworkConfigs.subnetworkRef

"Immutable. Name of the subnetwork where the additional pod network belongs."

### fn spec.networkConfig.additionalPodNetworkConfigs.subnetworkRef.withExternal
...
### fn spec.networkConfig.additionalPodNetworkConfigs.subnetworkRef.withName
...
### fn spec.networkConfig.additionalPodNetworkConfigs.subnetworkRef.withNamespace
...
## obj spec.networkConfig.podCidrOverprovisionConfig
...
### fn spec.networkConfig.podCidrOverprovisionConfig.withDisabled
...
## obj spec.nodeConfig.advancedMachineFeatures

"Immutable. Specifies options for controlling advanced machine features."

### fn spec.nodeConfig.advancedMachineFeatures.withThreadsPerCore
...
## obj spec.nodeConfig.confidentialNodes
...
### fn spec.nodeConfig.confidentialNodes.withEnabled
...
## obj spec.nodeConfig.ephemeralStorageLocalSsdConfig

"Immutable. Parameters for the ephemeral storage filesystem. If unspecified, ephemeral storage is backed by the boot disk."

### fn spec.nodeConfig.ephemeralStorageLocalSsdConfig.withLocalSsdCount
...
## obj spec.nodeConfig.fastSocket

"Enable or disable NCCL Fast Socket in the node pool."

### fn spec.nodeConfig.fastSocket.withEnabled
...
## obj spec.nodeConfig.guestAccelerator.gpuDriverInstallationConfig

"Immutable. Configuration for auto installation of GPU driver."

### fn spec.nodeConfig.guestAccelerator.gpuDriverInstallationConfig.withGpuDriverVersion
...
## obj spec.nodeConfig.hostMaintenancePolicy

"Immutable. The maintenance policy for the hosts on which the GKE VMs run on."

### fn spec.nodeConfig.hostMaintenancePolicy.withMaintenanceInterval
...
### fn spec.nodeConfig.kubeletConfig.withPodPidsLimit
...
### fn spec.nodeConfig.linuxNodeConfig.withCgroupMode
...
## obj spec.nodeConfig.localNvmeSsdBlockConfig

"Immutable. Parameters for raw-block local NVMe SSDs."

### fn spec.nodeConfig.localNvmeSsdBlockConfig.withLocalSsdCount
...
## obj spec.nodeConfig.soleTenantConfig

"Immutable. Node affinity options for sole tenant node pools."

### fn spec.nodeConfig.soleTenantConfig.withNodeAffinity
...
### fn spec.nodeConfig.soleTenantConfig.withNodeAffinityMixin
...
## obj spec.nodeConfig.soleTenantConfig.nodeAffinity

"Immutable. ."

### fn spec.nodeConfig.soleTenantConfig.nodeAffinity.withKey
...
### fn spec.nodeConfig.soleTenantConfig.nodeAffinity.withOperator
...
### fn spec.nodeConfig.soleTenantConfig.nodeAffinity.withValues
...
### fn spec.nodeConfig.soleTenantConfig.nodeAffinity.withValuesMixin
...
### fn spec.placementPolicy.withTpuTopology
...
## obj spec.placementPolicy.policyNameRef
...
### fn spec.placementPolicy.policyNameRef.withExternal
...
### fn spec.placementPolicy.policyNameRef.withName
...
### fn spec.placementPolicy.policyNameRef.withNamespace
...
### fn spec.upgradeSettings.withStrategy
...
## obj spec.upgradeSettings.blueGreenSettings

"Settings for BlueGreen node pool upgrade."

### fn spec.upgradeSettings.blueGreenSettings.withNodePoolSoakDuration
...
## obj spec.upgradeSettings.blueGreenSettings.standardRolloutPolicy

"Standard rollout policy is the default policy for blue-green."

### fn spec.upgradeSettings.blueGreenSettings.standardRolloutPolicy.withBatchNodeCount
...
### fn spec.upgradeSettings.blueGreenSettings.standardRolloutPolicy.withBatchPercentage
...
### fn spec.upgradeSettings.blueGreenSettings.standardRolloutPolicy.withBatchSoakDuration
