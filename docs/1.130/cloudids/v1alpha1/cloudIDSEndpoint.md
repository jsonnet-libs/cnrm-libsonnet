---
permalink: /1.130/cloudids/v1alpha1/cloudIDSEndpoint/
---

# cloudids.v1alpha1.cloudIDSEndpoint
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withThreatExceptions(threatExceptions)`](#fn-specwiththreatexceptions)
  * [`fn withThreatExceptionsMixin(threatExceptions)`](#fn-specwiththreatexceptionsmixin)
...
new returns an instance of CloudIDSEndpoint
...
### fn spec.withThreatExceptions

```ts
withThreatExceptions(threatExceptions)
```

"Configuration for threat IDs excluded from generating alerts. Limit: 99 IDs."

### fn spec.withThreatExceptionsMixin

```ts
withThreatExceptionsMixin(threatExceptions)
```
