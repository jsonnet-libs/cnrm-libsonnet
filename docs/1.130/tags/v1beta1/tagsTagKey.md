---
permalink: /1.130/tags/v1beta1/tagsTagKey/
---

# tags.v1beta1.tagsTagKey
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withPurposeData(purposeData)`](#fn-specwithpurposedata)
  * [`fn withPurposeDataMixin(purposeData)`](#fn-specwithpurposedatamixin)
  * [`fn withResourceID(resourceID)`](#fn-specwithresourceid)
  * [`fn withShortName(shortName)`](#fn-specwithshortname)
...
new returns an instance of TagsTagKey
...
### fn spec.withPurposeData

```ts
withPurposeData(purposeData)
```

"Immutable. Optional. Purpose data cannot be changed once set.\n\nPurpose data corresponds to the policy system that the tag is intended for. For example, the GCE_FIREWALL purpose expects data in the following format: 'network = \"<project-name>/<vpc-name>\"'."

### fn spec.withPurposeDataMixin

```ts
withPurposeDataMixin(purposeData)
```
