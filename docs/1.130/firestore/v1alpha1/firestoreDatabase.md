---
permalink: /1.130/firestore/v1alpha1/firestoreDatabase/
---

# firestore.v1alpha1.firestoreDatabase
...
* [`obj spec`](#obj-spec)
  * [`fn withConcurrencyMode(concurrencyMode)`](#fn-specwithconcurrencymode)
  * [`fn withLocationID(locationID)`](#fn-specwithlocationid)
  * [`fn withPointInTimeRecoveryEnablement(pointInTimeRecoveryEnablement)`](#fn-specwithpointintimerecoveryenablement)
...
new returns an instance of FirestoreDatabase
...
### fn spec.withPointInTimeRecoveryEnablement

```ts
withPointInTimeRecoveryEnablement(pointInTimeRecoveryEnablement)
```
