---
permalink: /1.130/sourcerepo/v1beta1/sourceRepoRepository/
---
...
### fn spec.withPubsubConfigs

```ts
withPubsubConfigs(pubsubConfigs)
```

"How this repository publishes a change in the repository through Cloud Pub/Sub.\nKeyed by the topic names."

### fn spec.withPubsubConfigsMixin

```ts
withPubsubConfigsMixin(pubsubConfigs)
```
