---
permalink: /1.130/gkehub/v1beta1/gkeHubFeatureMembership/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withMembershipLocation(membershipLocation)`](#fn-specwithmembershiplocation)
  * [`obj spec.configmanagement`](#obj-specconfigmanagement)
    ...
    * [`obj spec.configmanagement.configSync`](#obj-specconfigmanagementconfigsync)
      ...
      * [`obj spec.configmanagement.configSync.metricsGcpServiceAccountRef`](#obj-specconfigmanagementconfigsyncmetricsgcpserviceaccountref)
        * [`fn withExternal(external)`](#fn-specconfigmanagementconfigsyncmetricsgcpserviceaccountrefwithexternal)
        * [`fn withName(name)`](#fn-specconfigmanagementconfigsyncmetricsgcpserviceaccountrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specconfigmanagementconfigsyncmetricsgcpserviceaccountrefwithnamespace)
      * [`obj spec.configmanagement.configSync.oci`](#obj-specconfigmanagementconfigsyncoci)
        ...
        * [`obj spec.configmanagement.configSync.oci.gcpServiceAccountRef`](#obj-specconfigmanagementconfigsyncocigcpserviceaccountref)
  ...
  * [`obj spec.policycontroller`](#obj-specpolicycontroller)
    * [`fn withVersion(version)`](#fn-specpolicycontrollerwithversion)
    * [`obj spec.policycontroller.policyControllerHubConfig`](#obj-specpolicycontrollerpolicycontrollerhubconfig)
      * [`fn withAuditIntervalSeconds(auditIntervalSeconds)`](#fn-specpolicycontrollerpolicycontrollerhubconfigwithauditintervalseconds)
      * [`fn withConstraintViolationLimit(constraintViolationLimit)`](#fn-specpolicycontrollerpolicycontrollerhubconfigwithconstraintviolationlimit)
      * [`fn withExemptableNamespaces(exemptableNamespaces)`](#fn-specpolicycontrollerpolicycontrollerhubconfigwithexemptablenamespaces)
      * [`fn withExemptableNamespacesMixin(exemptableNamespaces)`](#fn-specpolicycontrollerpolicycontrollerhubconfigwithexemptablenamespacesmixin)
      * [`fn withInstallSpec(installSpec)`](#fn-specpolicycontrollerpolicycontrollerhubconfigwithinstallspec)
      * [`fn withLogDeniesEnabled(logDeniesEnabled)`](#fn-specpolicycontrollerpolicycontrollerhubconfigwithlogdeniesenabled)
      * [`fn withMutationEnabled(mutationEnabled)`](#fn-specpolicycontrollerpolicycontrollerhubconfigwithmutationenabled)
      * [`fn withReferentialRulesEnabled(referentialRulesEnabled)`](#fn-specpolicycontrollerpolicycontrollerhubconfigwithreferentialrulesenabled)
      * [`obj spec.policycontroller.policyControllerHubConfig.monitoring`](#obj-specpolicycontrollerpolicycontrollerhubconfigmonitoring)
        * [`fn withBackends(backends)`](#fn-specpolicycontrollerpolicycontrollerhubconfigmonitoringwithbackends)
        * [`fn withBackendsMixin(backends)`](#fn-specpolicycontrollerpolicycontrollerhubconfigmonitoringwithbackendsmixin)
      * [`obj spec.policycontroller.policyControllerHubConfig.policyContent`](#obj-specpolicycontrollerpolicycontrollerhubconfigpolicycontent)
        * [`obj spec.policycontroller.policyControllerHubConfig.policyContent.templateLibrary`](#obj-specpolicycontrollerpolicycontrollerhubconfigpolicycontenttemplatelibrary)
          * [`fn withInstallation(installation)`](#fn-specpolicycontrollerpolicycontrollerhubconfigpolicycontenttemplatelibrarywithinstallation)
