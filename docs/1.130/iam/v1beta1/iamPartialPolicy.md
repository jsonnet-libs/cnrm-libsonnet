---
permalink: /1.130/iam/v1beta1/iamPartialPolicy/
---
  ...
  * [`obj spec.bindings`](#obj-specbindings)
    ...
    * [`obj spec.bindings.members`](#obj-specbindingsmembers)
      ...
      * [`obj spec.bindings.members.memberFrom`](#obj-specbindingsmembersmemberfrom)
        ...
        * [`obj spec.bindings.members.memberFrom.serviceIdentityRef`](#obj-specbindingsmembersmemberfromserviceidentityref)
          * [`fn withName(name)`](#fn-specbindingsmembersmemberfromserviceidentityrefwithname)
          * [`fn withNamespace(namespace)`](#fn-specbindingsmembersmemberfromserviceidentityrefwithnamespace)
        * [`obj spec.bindings.members.memberFrom.sqlInstanceRef`](#obj-specbindingsmembersmemberfromsqlinstanceref)
          * [`fn withName(name)`](#fn-specbindingsmembersmemberfromsqlinstancerefwithname)
          * [`fn withNamespace(namespace)`](#fn-specbindingsmembersmemberfromsqlinstancerefwithnamespace)
...
## obj spec.bindings.members.memberFrom.serviceIdentityRef

"The ServiceIdentity whose service account (i.e., its 'status.email') is to be bound to the role."

### fn spec.bindings.members.memberFrom.serviceIdentityRef.withName
...
### fn spec.bindings.members.memberFrom.serviceIdentityRef.withNamespace
...
## obj spec.bindings.members.memberFrom.sqlInstanceRef

"The SQLInstance whose service account (i.e. its 'status.serviceAccountEmailAddress') is to be bound to the role."

### fn spec.bindings.members.memberFrom.sqlInstanceRef.withName
...
### fn spec.bindings.members.memberFrom.sqlInstanceRef.withNamespace
