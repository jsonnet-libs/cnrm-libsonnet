---
permalink: /1.130/iam/v1beta1/iamServiceAccountKey/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withPrivateKeyType(privateKeyType)`](#fn-specwithprivatekeytype)
  * [`fn withPublicKeyData(publicKeyData)`](#fn-specwithpublickeydata)
  * [`fn withPublicKeyType(publicKeyType)`](#fn-specwithpublickeytype)
...
### fn spec.withPrivateKeyType

```ts
withPrivateKeyType(privateKeyType)
```

"Immutable."

### fn spec.withPublicKeyData

```ts
withPublicKeyData(publicKeyData)
```
...
### fn spec.withPublicKeyType

```ts
withPublicKeyType(publicKeyType)
```
