---
permalink: /1.130/iam/v1beta1/iamWorkforcePoolProvider/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.oidc`](#obj-specoidc)
    ...
    * [`fn withJwksJson(jwksJson)`](#fn-specoidcwithjwksjson)
    * [`obj spec.oidc.clientSecret`](#obj-specoidcclientsecret)
      * [`obj spec.oidc.clientSecret.value`](#obj-specoidcclientsecretvalue)
        * [`obj spec.oidc.clientSecret.value.plainText`](#obj-specoidcclientsecretvalueplaintext)
          * [`fn withValue(value)`](#fn-specoidcclientsecretvalueplaintextwithvalue)
          * [`obj spec.oidc.clientSecret.value.plainText.valueFrom`](#obj-specoidcclientsecretvalueplaintextvaluefrom)
            * [`obj spec.oidc.clientSecret.value.plainText.valueFrom.secretKeyRef`](#obj-specoidcclientsecretvalueplaintextvaluefromsecretkeyref)
              * [`fn withKey(key)`](#fn-specoidcclientsecretvalueplaintextvaluefromsecretkeyrefwithkey)
              * [`fn withName(name)`](#fn-specoidcclientsecretvalueplaintextvaluefromsecretkeyrefwithname)
    * [`obj spec.oidc.webSsoConfig`](#obj-specoidcwebssoconfig)
      * [`fn withAdditionalScopes(additionalScopes)`](#fn-specoidcwebssoconfigwithadditionalscopes)
      * [`fn withAdditionalScopesMixin(additionalScopes)`](#fn-specoidcwebssoconfigwithadditionalscopesmixin)
      * [`fn withAssertionClaimsBehavior(assertionClaimsBehavior)`](#fn-specoidcwebssoconfigwithassertionclaimsbehavior)
      * [`fn withResponseType(responseType)`](#fn-specoidcwebssoconfigwithresponsetype)
  * [`obj spec.saml`](#obj-specsaml)
    * [`fn withIdpMetadataXml(idpMetadataXml)`](#fn-specsamlwithidpmetadataxml)
  * [`obj spec.workforcePoolRef`](#obj-specworkforcepoolref)
    * [`fn withExternal(external)`](#fn-specworkforcepoolrefwithexternal)
    * [`fn withName(name)`](#fn-specworkforcepoolrefwithname)
    * [`fn withNamespace(namespace)`](#fn-specworkforcepoolrefwithnamespace)
