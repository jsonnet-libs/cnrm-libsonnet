---
permalink: /1.130/kms/v1alpha1/kmsKeyHandle/
---

# kms.v1alpha1.kmsKeyHandle
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withResourceTypeSelector(resourceTypeSelector)`](#fn-specwithresourcetypeselector)
...
new returns an instance of KMSKeyHandle
...
### fn spec.withResourceTypeSelector

```ts
withResourceTypeSelector(resourceTypeSelector)
```
