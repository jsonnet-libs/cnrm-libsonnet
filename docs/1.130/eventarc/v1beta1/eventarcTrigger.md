---
permalink: /1.130/eventarc/v1beta1/eventarcTrigger/
---
...
* [`obj spec`](#obj-spec)
  * [`fn withEventDataContentType(eventDataContentType)`](#fn-specwitheventdatacontenttype)
  ...
  * [`obj spec.destination`](#obj-specdestination)
    ...
    * [`obj spec.destination.httpEndpoint`](#obj-specdestinationhttpendpoint)
      * [`fn withUri(uri)`](#fn-specdestinationhttpendpointwithuri)
    * [`obj spec.destination.networkConfig`](#obj-specdestinationnetworkconfig)
      * [`obj spec.destination.networkConfig.networkAttachmentRef`](#obj-specdestinationnetworkconfignetworkattachmentref)
        * [`fn withExternal(external)`](#fn-specdestinationnetworkconfignetworkattachmentrefwithexternal)
        * [`fn withName(name)`](#fn-specdestinationnetworkconfignetworkattachmentrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specdestinationnetworkconfignetworkattachmentrefwithnamespace)
...
### fn spec.withEventDataContentType
...
## obj spec.destination.httpEndpoint

"An HTTP endpoint destination described by an URI."

### fn spec.destination.httpEndpoint.withUri
...
## obj spec.destination.networkConfig

"Optional. Network config is used to configure how Eventarc resolves and connect to a destination. This should only be used with HttpEndpoint destination type."

## obj spec.destination.networkConfig.networkAttachmentRef



### fn spec.destination.networkConfig.networkAttachmentRef.withExternal
...
### fn spec.destination.networkConfig.networkAttachmentRef.withName
...
### fn spec.destination.networkConfig.networkAttachmentRef.withNamespace
