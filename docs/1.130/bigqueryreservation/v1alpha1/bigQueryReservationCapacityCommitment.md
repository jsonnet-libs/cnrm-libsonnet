---
permalink: /1.130/bigqueryreservation/v1alpha1/bigQueryReservationCapacityCommitment/
---

# bigqueryreservation.v1alpha1.bigQueryReservationCapacityCommitment
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withEnforceSingleAdminProjectPerOrg(enforceSingleAdminProjectPerOrg)`](#fn-specwithenforcesingleadminprojectperorg)
  * [`fn withLocation(location)`](#fn-specwithlocation)
  * [`fn withPlan(plan)`](#fn-specwithplan)
  * [`fn withRenewalPlan(renewalPlan)`](#fn-specwithrenewalplan)
  * [`fn withResourceID(resourceID)`](#fn-specwithresourceid)
  * [`fn withSlotCount(slotCount)`](#fn-specwithslotcount)
...
new returns an instance of BigQueryReservationCapacityCommitment
...
### fn spec.withEnforceSingleAdminProjectPerOrg

```ts
withEnforceSingleAdminProjectPerOrg(enforceSingleAdminProjectPerOrg)
```
...
### fn spec.withRenewalPlan

```ts
withRenewalPlan(renewalPlan)
```
