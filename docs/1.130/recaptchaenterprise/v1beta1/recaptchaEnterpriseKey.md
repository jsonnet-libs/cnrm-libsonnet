---
permalink: /1.130/recaptchaenterprise/v1beta1/recaptchaEnterpriseKey/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.wafSettings`](#obj-specwafsettings)
    * [`fn withWafFeature(wafFeature)`](#fn-specwafsettingswithwaffeature)
    * [`fn withWafService(wafService)`](#fn-specwafsettingswithwafservice)
...
### fn spec.wafSettings.withWafService

```ts
withWafService(wafService)
```
