---
permalink: /1.130/networkconnectivity/v1beta1/networkConnectivitySpoke/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.linkedVPCNetwork`](#obj-speclinkedvpcnetwork)
    * [`fn withExcludeExportRanges(excludeExportRanges)`](#fn-speclinkedvpcnetworkwithexcludeexportranges)
    * [`fn withExcludeExportRangesMixin(excludeExportRanges)`](#fn-speclinkedvpcnetworkwithexcludeexportrangesmixin)
    * [`obj spec.linkedVPCNetwork.uriRef`](#obj-speclinkedvpcnetworkuriref)
      * [`fn withExternal(external)`](#fn-speclinkedvpcnetworkurirefwithexternal)
      * [`fn withName(name)`](#fn-speclinkedvpcnetworkurirefwithname)
      * [`fn withNamespace(namespace)`](#fn-speclinkedvpcnetworkurirefwithnamespace)
...
## obj spec.linkedVPCNetwork

"Immutable. VPC network that is associated with the spoke."

### fn spec.linkedVPCNetwork.withExcludeExportRanges
...
### fn spec.linkedVPCNetwork.withExcludeExportRangesMixin
...
## obj spec.linkedVPCNetwork.uriRef

"Immutable."

### fn spec.linkedVPCNetwork.uriRef.withExternal
...
### fn spec.linkedVPCNetwork.uriRef.withName
...
### fn spec.linkedVPCNetwork.uriRef.withNamespace
