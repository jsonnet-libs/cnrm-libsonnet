{
  ...
  '#':: d.pkg(name='firebaseStorageBucket', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of FirebaseStorageBucket', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withResourceID':: d.fn(help='"Immutable. Optional. The bucketId of the resource. Used for creation and acquisition. When unset, the value of `metadata.name` is used as the default."', args=[d.arg(name='resourceID', type=d.T.string)]),
