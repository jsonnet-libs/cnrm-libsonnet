{
  ...
  '#':: d.pkg(name='healthcareDataset', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of HealthcareDataset', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withLocation':: d.fn(help='"Immutable. The location for the Dataset."', args=[d.arg(name='location', type=d.T.string)]),
    ...
    '#withTimeZone':: d.fn(help='"The default timezone used by this dataset. Must be a either a valid IANA time zone name such as\\n\\"America/New_York\\" or empty, which defaults to UTC. This is used for parsing times in resources\\n(e.g., HL7 messages) where no explicit timezone is specified."', args=[d.arg(name='timeZone', type=d.T.string)]),
