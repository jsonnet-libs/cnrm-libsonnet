{
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#secretData':: d.obj(help='"Immutable. The secret data. Must be no larger than 64KiB."'),
    secretData: {
    ...
    secretRef: {
      ...
      withExternal(external): { spec+: { secretRef+: { external: external } } },
    ...
    '#withDeletionPolicy':: d.fn(help="\"The deletion policy for the secret version. Setting 'ABANDON' allows the resource\\nto be abandoned rather than deleted. Setting 'DISABLE' allows the resource to be\\ndisabled rather than deleted. Default is 'DELETE'. Possible values are:\\n  * DELETE\\n  * DISABLE\\n  * ABANDON.\"", args=[d.arg(name='deletionPolicy', type=d.T.string)]),
    withDeletionPolicy(deletionPolicy): { spec+: { deletionPolicy: deletionPolicy } },
    '#withEnabled':: d.fn(help='"The current state of the SecretVersion."', args=[d.arg(name='enabled', type=d.T.boolean)]),
    withEnabled(enabled): { spec+: { enabled: enabled } },
    '#withIsSecretDataBase64':: d.fn(help="\"Immutable. If set to 'true', the secret data is expected to be base64-encoded string and would be sent as is.\"", args=[d.arg(name='isSecretDataBase64', type=d.T.boolean)]),
    withIsSecretDataBase64(isSecretDataBase64): { spec+: { isSecretDataBase64: isSecretDataBase64 } },
