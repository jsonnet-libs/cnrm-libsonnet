{
  ...
  '#':: d.pkg(name='dialogflowEntityType', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of DialogflowEntityType', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    entities: {
      '#withSynonyms':: d.fn(help='"A collection of value synonyms. For example, if the entity type is vegetable, and value is scallions, a synonym\\ncould be green onions.\\nFor KIND_LIST entity types:\\n* This collection must contain exactly one synonym equal to value."', args=[d.arg(name='synonyms', type=d.T.array)]),
      withSynonyms(synonyms): { synonyms: if std.isArray(v=synonyms) then synonyms else [synonyms] },
      '#withSynonymsMixin':: d.fn(help='"A collection of value synonyms. For example, if the entity type is vegetable, and value is scallions, a synonym\\ncould be green onions.\\nFor KIND_LIST entity types:\\n* This collection must contain exactly one synonym equal to value."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='synonyms', type=d.T.array)]),
      withSynonymsMixin(synonyms): { synonyms+: if std.isArray(v=synonyms) then synonyms else [synonyms] },
      '#withValue':: d.fn(help='"The primary value associated with this entity entry. For example, if the entity type is vegetable, the value\\ncould be scallions.\\nFor KIND_MAP entity types:\\n* A reference value to be used in place of synonyms.\\nFor KIND_LIST entity types:\\n* A string that can contain references to other entity types (with or without aliases)."', args=[d.arg(name='value', type=d.T.string)]),
    ...
    '#withDisplayName':: d.fn(help='"The name of this entity type to be displayed on the console."', args=[d.arg(name='displayName', type=d.T.string)]),
