{
  ...
  spec: {
    ...
    managementConfig: {
      '#fullManagementConfig':: d.obj(help='"Immutable. Configuration of the full (Autopilot) cluster management"'),
      fullManagementConfig: {
        ...
        networkRef: {
          ...
          withExternal(external): { spec+: { managementConfig+: { fullManagementConfig+: { networkRef+: { external: external } } } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { managementConfig+: { fullManagementConfig+: { networkRef+: { name: name } } } } },
          ...
          withNamespace(namespace): { spec+: { managementConfig+: { fullManagementConfig+: { networkRef+: { namespace: namespace } } } } },
        },
        ...
        withClusterCidrBlock(clusterCidrBlock): { spec+: { managementConfig+: { fullManagementConfig+: { clusterCidrBlock: clusterCidrBlock } } } },
        ...
        withClusterNamedRange(clusterNamedRange): { spec+: { managementConfig+: { fullManagementConfig+: { clusterNamedRange: clusterNamedRange } } } },
        ...
        withManBlock(manBlock): { spec+: { managementConfig+: { fullManagementConfig+: { manBlock: manBlock } } } },
        ...
        withMasterIPv4CidrBlock(masterIPv4CidrBlock): { spec+: { managementConfig+: { fullManagementConfig+: { masterIPv4CidrBlock: masterIPv4CidrBlock } } } },
        ...
        withServicesCidrBlock(servicesCidrBlock): { spec+: { managementConfig+: { fullManagementConfig+: { servicesCidrBlock: servicesCidrBlock } } } },
        ...
        withServicesNamedRange(servicesNamedRange): { spec+: { managementConfig+: { fullManagementConfig+: { servicesNamedRange: servicesNamedRange } } } },
      },
