{
  ...
  '#':: d.pkg(name='dataCatalogEntryGroup', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of DataCatalogEntryGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withDescription':: d.fn(help='"Entry group description, which can consist of several sentences or paragraphs that describe entry group contents."', args=[d.arg(name='description', type=d.T.string)]),
    withDescription(description): { spec+: { description: description } },
    '#withDisplayName':: d.fn(help='"A short name to identify the entry group, for example, \\"analytics data - jan 2011\\"."', args=[d.arg(name='displayName', type=d.T.string)]),
    withDisplayName(displayName): { spec+: { displayName: displayName } },
    '#withEntryGroupId':: d.fn(help='"Immutable. The id of the entry group to create. The id must begin with a letter or underscore,\\ncontain only English letters, numbers and underscores, and be at most 64 characters."', args=[d.arg(name='entryGroupId', type=d.T.string)]),
    withEntryGroupId(entryGroupId): { spec+: { entryGroupId: entryGroupId } },
    '#withRegion':: d.fn(help='"Immutable. EntryGroup location region."', args=[d.arg(name='region', type=d.T.string)]),
