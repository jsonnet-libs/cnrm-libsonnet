{
  ...
  '#':: d.pkg(name='privateCACAPool', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of PrivateCACAPool', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#issuancePolicy':: d.obj(help='"Optional. The IssuancePolicy to control how Certificates will be issued from this CaPool."'),
    issuancePolicy: {
      '#allowedIssuanceModes':: d.obj(help='"Optional. If specified, then only methods allowed in the IssuanceModes may be used to issue Certificates."'),
      allowedIssuanceModes: {
        '#withAllowConfigBasedIssuance':: d.fn(help='"Optional. When true, allows callers to create Certificates by specifying a CertificateConfig."', args=[d.arg(name='allowConfigBasedIssuance', type=d.T.boolean)]),
        withAllowConfigBasedIssuance(allowConfigBasedIssuance): { spec+: { issuancePolicy+: { allowedIssuanceModes+: { allowConfigBasedIssuance: allowConfigBasedIssuance } } } },
        '#withAllowCsrBasedIssuance':: d.fn(help='"Optional. When true, allows callers to create Certificates by specifying a CSR."', args=[d.arg(name='allowCsrBasedIssuance', type=d.T.boolean)]),
        withAllowCsrBasedIssuance(allowCsrBasedIssuance): { spec+: { issuancePolicy+: { allowedIssuanceModes+: { allowCsrBasedIssuance: allowCsrBasedIssuance } } } },
      },
      '#allowedKeyTypes':: d.obj(help="\"Optional. If any AllowedKeyType is specified, then the certificate request's public key must match one of the key types listed here. Otherwise, any key may be used.\""),
      allowedKeyTypes: {
        '#ellipticCurve':: d.obj(help='"Represents an allowed Elliptic Curve key type."'),
        ellipticCurve: {
          '#withSignatureAlgorithm':: d.fn(help='"Optional. A signature algorithm that must be used. If this is omitted, any EC-based signature algorithm will be allowed. Possible values: EC_SIGNATURE_ALGORITHM_UNSPECIFIED, ECDSA_P256, ECDSA_P384, EDDSA_25519"', args=[d.arg(name='signatureAlgorithm', type=d.T.string)]),
          withSignatureAlgorithm(signatureAlgorithm): { ellipticCurve+: { signatureAlgorithm: signatureAlgorithm } },
        },
        '#rsa':: d.obj(help='"Represents an allowed RSA key type."'),
        rsa: {
          '#withMaxModulusSize':: d.fn(help='"Optional. The maximum allowed RSA modulus size, in bits. If this is not set, or if set to zero, the service will not enforce an explicit upper bound on RSA modulus sizes."', args=[d.arg(name='maxModulusSize', type=d.T.integer)]),
          withMaxModulusSize(maxModulusSize): { rsa+: { maxModulusSize: maxModulusSize } },
          '#withMinModulusSize':: d.fn(help='"Optional. The minimum allowed RSA modulus size, in bits. If this is not set, or if set to zero, the service-level min RSA modulus size will continue to apply."', args=[d.arg(name='minModulusSize', type=d.T.integer)]),
          withMinModulusSize(minModulusSize): { rsa+: { minModulusSize: minModulusSize } },
        },
      },
      '#baselineValues':: d.obj(help='"Optional. A set of X.509 values that will be applied to all certificates issued through this CaPool. If a certificate request includes conflicting values for the same properties, they will be overwritten by the values defined here. If a certificate request uses a CertificateTemplate that defines conflicting predefined_values for the same properties, the certificate issuance request will fail."'),
      baselineValues: {
        ...
        caOptions: {
          ...
          withIsCa(isCa): { spec+: { issuancePolicy+: { baselineValues+: { caOptions+: { isCa: isCa } } } } },
          ...
          withMaxIssuerPathLength(maxIssuerPathLength): { spec+: { issuancePolicy+: { baselineValues+: { caOptions+: { maxIssuerPathLength: maxIssuerPathLength } } } } },
          '#withZeroMaxIssuerPathLength':: d.fn(help='"Optional. When true, the \\"path length constraint\\" in Basic Constraints extension will be set to 0. if both max_issuer_path_length and zero_max_issuer_path_length are unset, the max path length will be omitted from the CA certificate."', args=[d.arg(name='zeroMaxIssuerPathLength', type=d.T.boolean)]),
          withZeroMaxIssuerPathLength(zeroMaxIssuerPathLength): { spec+: { issuancePolicy+: { baselineValues+: { caOptions+: { zeroMaxIssuerPathLength: zeroMaxIssuerPathLength } } } } },
        },
        ...
        keyUsage: {
          ...
          baseKeyUsage: {
            ...
            withCertSign(certSign): { spec+: { issuancePolicy+: { baselineValues+: { keyUsage+: { baseKeyUsage+: { certSign: certSign } } } } } },
            ...
            withContentCommitment(contentCommitment): { spec+: { issuancePolicy+: { baselineValues+: { keyUsage+: { baseKeyUsage+: { contentCommitment: contentCommitment } } } } } },
            '#withCrlSign':: d.fn(help='"The key may be used sign certificate revocation lists."', args=[d.arg(name='crlSign', type=d.T.boolean)]),
            withCrlSign(crlSign): { spec+: { issuancePolicy+: { baselineValues+: { keyUsage+: { baseKeyUsage+: { crlSign: crlSign } } } } } },
            '#withDataEncipherment':: d.fn(help='"The key may be used to encipher data."', args=[d.arg(name='dataEncipherment', type=d.T.boolean)]),
            withDataEncipherment(dataEncipherment): { spec+: { issuancePolicy+: { baselineValues+: { keyUsage+: { baseKeyUsage+: { dataEncipherment: dataEncipherment } } } } } },
            '#withDecipherOnly':: d.fn(help='"The key may be used to decipher only."', args=[d.arg(name='decipherOnly', type=d.T.boolean)]),
            withDecipherOnly(decipherOnly): { spec+: { issuancePolicy+: { baselineValues+: { keyUsage+: { baseKeyUsage+: { decipherOnly: decipherOnly } } } } } },
            ...
            withDigitalSignature(digitalSignature): { spec+: { issuancePolicy+: { baselineValues+: { keyUsage+: { baseKeyUsage+: { digitalSignature: digitalSignature } } } } } },
            '#withEncipherOnly':: d.fn(help='"The key may be used to encipher only."', args=[d.arg(name='encipherOnly', type=d.T.boolean)]),
            withEncipherOnly(encipherOnly): { spec+: { issuancePolicy+: { baselineValues+: { keyUsage+: { baseKeyUsage+: { encipherOnly: encipherOnly } } } } } },
            '#withKeyAgreement':: d.fn(help='"The key may be used in a key agreement protocol."', args=[d.arg(name='keyAgreement', type=d.T.boolean)]),
            withKeyAgreement(keyAgreement): { spec+: { issuancePolicy+: { baselineValues+: { keyUsage+: { baseKeyUsage+: { keyAgreement: keyAgreement } } } } } },
            ...
            withKeyEncipherment(keyEncipherment): { spec+: { issuancePolicy+: { baselineValues+: { keyUsage+: { baseKeyUsage+: { keyEncipherment: keyEncipherment } } } } } },
          },
          ...
          extendedKeyUsage: {
            ...
            withClientAuth(clientAuth): { spec+: { issuancePolicy+: { baselineValues+: { keyUsage+: { extendedKeyUsage+: { clientAuth: clientAuth } } } } } },
            ...
            withCodeSigning(codeSigning): { spec+: { issuancePolicy+: { baselineValues+: { keyUsage+: { extendedKeyUsage+: { codeSigning: codeSigning } } } } } },
            ...
            withEmailProtection(emailProtection): { spec+: { issuancePolicy+: { baselineValues+: { keyUsage+: { extendedKeyUsage+: { emailProtection: emailProtection } } } } } },
            ...
            withOcspSigning(ocspSigning): { spec+: { issuancePolicy+: { baselineValues+: { keyUsage+: { extendedKeyUsage+: { ocspSigning: ocspSigning } } } } } },
            ...
            withServerAuth(serverAuth): { spec+: { issuancePolicy+: { baselineValues+: { keyUsage+: { extendedKeyUsage+: { serverAuth: serverAuth } } } } } },
            ...
            withTimeStamping(timeStamping): { spec+: { issuancePolicy+: { baselineValues+: { keyUsage+: { extendedKeyUsage+: { timeStamping: timeStamping } } } } } },
          },
          ...
          withUnknownExtendedKeyUsages(unknownExtendedKeyUsages): { spec+: { issuancePolicy+: { baselineValues+: { keyUsage+: { unknownExtendedKeyUsages: if std.isArray(v=unknownExtendedKeyUsages) then unknownExtendedKeyUsages else [unknownExtendedKeyUsages] } } } } },
          ...
          withUnknownExtendedKeyUsagesMixin(unknownExtendedKeyUsages): { spec+: { issuancePolicy+: { baselineValues+: { keyUsage+: { unknownExtendedKeyUsages+: if std.isArray(v=unknownExtendedKeyUsages) then unknownExtendedKeyUsages else [unknownExtendedKeyUsages] } } } } },
        },
        ...
        withAdditionalExtensions(additionalExtensions): { spec+: { issuancePolicy+: { baselineValues+: { additionalExtensions: if std.isArray(v=additionalExtensions) then additionalExtensions else [additionalExtensions] } } } },
        ...
        withAdditionalExtensionsMixin(additionalExtensions): { spec+: { issuancePolicy+: { baselineValues+: { additionalExtensions+: if std.isArray(v=additionalExtensions) then additionalExtensions else [additionalExtensions] } } } },
        ...
        withAiaOcspServers(aiaOcspServers): { spec+: { issuancePolicy+: { baselineValues+: { aiaOcspServers: if std.isArray(v=aiaOcspServers) then aiaOcspServers else [aiaOcspServers] } } } },
        ...
        withAiaOcspServersMixin(aiaOcspServers): { spec+: { issuancePolicy+: { baselineValues+: { aiaOcspServers+: if std.isArray(v=aiaOcspServers) then aiaOcspServers else [aiaOcspServers] } } } },
        ...
        withPolicyIds(policyIds): { spec+: { issuancePolicy+: { baselineValues+: { policyIds: if std.isArray(v=policyIds) then policyIds else [policyIds] } } } },
        ...
        withPolicyIdsMixin(policyIds): { spec+: { issuancePolicy+: { baselineValues+: { policyIds+: if std.isArray(v=policyIds) then policyIds else [policyIds] } } } },
      },
      '#identityConstraints':: d.obj(help="\"Optional. Describes constraints on identities that may appear in Certificates issued through this CaPool. If this is omitted, then this CaPool will not add restrictions on a certificate's identity.\""),
      identityConstraints: {
        ...
        celExpression: {
          ...
          withDescription(description): { spec+: { issuancePolicy+: { identityConstraints+: { celExpression+: { description: description } } } } },
          ...
          withExpression(expression): { spec+: { issuancePolicy+: { identityConstraints+: { celExpression+: { expression: expression } } } } },
          ...
          withLocation(location): { spec+: { issuancePolicy+: { identityConstraints+: { celExpression+: { location: location } } } } },
          ...
          withTitle(title): { spec+: { issuancePolicy+: { identityConstraints+: { celExpression+: { title: title } } } } },
        },
        ...
        withAllowSubjectAltNamesPassthrough(allowSubjectAltNamesPassthrough): { spec+: { issuancePolicy+: { identityConstraints+: { allowSubjectAltNamesPassthrough: allowSubjectAltNamesPassthrough } } } },
        ...
        withAllowSubjectPassthrough(allowSubjectPassthrough): { spec+: { issuancePolicy+: { identityConstraints+: { allowSubjectPassthrough: allowSubjectPassthrough } } } },
      },
      ...
      passthroughExtensions: {
        ...
        withAdditionalExtensions(additionalExtensions): { spec+: { issuancePolicy+: { passthroughExtensions+: { additionalExtensions: if std.isArray(v=additionalExtensions) then additionalExtensions else [additionalExtensions] } } } },
        ...
        withAdditionalExtensionsMixin(additionalExtensions): { spec+: { issuancePolicy+: { passthroughExtensions+: { additionalExtensions+: if std.isArray(v=additionalExtensions) then additionalExtensions else [additionalExtensions] } } } },
        ...
        withKnownExtensions(knownExtensions): { spec+: { issuancePolicy+: { passthroughExtensions+: { knownExtensions: if std.isArray(v=knownExtensions) then knownExtensions else [knownExtensions] } } } },
        ...
        withKnownExtensionsMixin(knownExtensions): { spec+: { issuancePolicy+: { passthroughExtensions+: { knownExtensions+: if std.isArray(v=knownExtensions) then knownExtensions else [knownExtensions] } } } },
      },
      '#withAllowedKeyTypes':: d.fn(help="\"Optional. If any AllowedKeyType is specified, then the certificate request's public key must match one of the key types listed here. Otherwise, any key may be used.\"", args=[d.arg(name='allowedKeyTypes', type=d.T.array)]),
      withAllowedKeyTypes(allowedKeyTypes): { spec+: { issuancePolicy+: { allowedKeyTypes: if std.isArray(v=allowedKeyTypes) then allowedKeyTypes else [allowedKeyTypes] } } },
      '#withAllowedKeyTypesMixin':: d.fn(help="\"Optional. If any AllowedKeyType is specified, then the certificate request's public key must match one of the key types listed here. Otherwise, any key may be used.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='allowedKeyTypes', type=d.T.array)]),
      withAllowedKeyTypesMixin(allowedKeyTypes): { spec+: { issuancePolicy+: { allowedKeyTypes+: if std.isArray(v=allowedKeyTypes) then allowedKeyTypes else [allowedKeyTypes] } } },
      '#withMaximumLifetime':: d.fn(help="\"Optional. The maximum lifetime allowed for issued Certificates. Note that if the issuing CertificateAuthority expires before a Certificate's requested maximum_lifetime, the effective lifetime will be explicitly truncated to match it.\"", args=[d.arg(name='maximumLifetime', type=d.T.string)]),
      withMaximumLifetime(maximumLifetime): { spec+: { issuancePolicy+: { maximumLifetime: maximumLifetime } } },
    },
    ...
    '#withTier':: d.fn(help='"Immutable. Required. Immutable. The Tier of this CaPool. Possible values: TIER_UNSPECIFIED, ENTERPRISE, DEVOPS"', args=[d.arg(name='tier', type=d.T.string)]),
