{
  ...
  '#':: d.pkg(name='firebaseProject', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of FirebaseProject', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withResourceID':: d.fn(help='"Immutable. Optional. The project of the resource. Used for creation and acquisition. When unset, the value of `metadata.name` is used as the default."', args=[d.arg(name='resourceID', type=d.T.string)]),
