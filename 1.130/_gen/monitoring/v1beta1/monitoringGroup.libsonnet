{
  ...
  '#':: d.pkg(name='monitoringGroup', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of MonitoringGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#parentRef':: d.obj(help=''),
    parentRef: {
      '#withExternal':: d.fn(help="\"The name of the group's parent, if it has one. The format is: projects/ For groups with no parent, `parent_name` is the empty string, ``.\\n\\nAllowed value: The Google Cloud resource name of a `MonitoringGroup` resource (format: `projects/{{project}}/groups/{{name}}`).\"", args=[d.arg(name='external', type=d.T.string)]),
      withExternal(external): { spec+: { parentRef+: { external: external } } },
    ...
    '#withDisplayName':: d.fn(help='"A user-assigned name for this group, used only for display purposes."', args=[d.arg(name='displayName', type=d.T.string)]),
    withDisplayName(displayName): { spec+: { displayName: displayName } },
    '#withFilter':: d.fn(help='"The filter used to determine which monitored resources belong to this group."', args=[d.arg(name='filter', type=d.T.string)]),
    withFilter(filter): { spec+: { filter: filter } },
    '#withIsCluster':: d.fn(help='"If true, the members of this group are considered to be a cluster. The system can perform additional analysis on groups that are clusters."', args=[d.arg(name='isCluster', type=d.T.boolean)]),
    withIsCluster(isCluster): { spec+: { isCluster: isCluster } },
