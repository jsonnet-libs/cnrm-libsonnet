{
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#contentMatchers':: d.obj(help='"The content that is expected to appear in the data returned by the target server against which the check is run.  Currently, only the first entry in the `content_matchers` list is supported, and additional entries will be ignored. This field is optional and should only be specified if a content match is required as part of the/ Uptime check."'),
    contentMatchers: {
      '#withContent':: d.fn(help='', args=[d.arg(name='content', type=d.T.string)]),
      withContent(content): { content: content },
      '#withMatcher':: d.fn(help='" Possible values: CONTENT_MATCHER_OPTION_UNSPECIFIED, CONTAINS_STRING, NOT_CONTAINS_STRING, MATCHES_REGEX, NOT_MATCHES_REGEX"', args=[d.arg(name='matcher', type=d.T.string)]),
    ...
    httpCheck: {
      ...
      '#withContentType':: d.fn(help='"Immutable. The content type to use for the check.  Possible values: TYPE_UNSPECIFIED, URL_ENCODED"', args=[d.arg(name='contentType', type=d.T.string)]),
      ...
      '#withRequestMethod':: d.fn(help='"Immutable. The HTTP request method to use for the check. If set to `METHOD_UNSPECIFIED` then `request_method` defaults to `GET`."', args=[d.arg(name='requestMethod', type=d.T.string)]),
    ...
    '#monitoredResource':: d.obj(help='"Immutable. The [monitored resource](https://cloud.google.com/monitoring/api/resources) associated with the configuration. The following monitored resource types are supported for Uptime checks:   `uptime_url`,   `gce_instance`,   `gae_app`,   `aws_ec2_instance`,   `aws_elb_load_balancer`"'),
    monitoredResource: {
      '#withFilterLabels':: d.fn(help='"Immutable."', args=[d.arg(name='filterLabels', type=d.T.object)]),
      withFilterLabels(filterLabels): { spec+: { monitoredResource+: { filterLabels: filterLabels } } },
      '#withFilterLabelsMixin':: d.fn(help='"Immutable."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='filterLabels', type=d.T.object)]),
      withFilterLabelsMixin(filterLabels): { spec+: { monitoredResource+: { filterLabels+: filterLabels } } },
      '#withType':: d.fn(help='"Immutable."', args=[d.arg(name='type', type=d.T.string)]),
    ...
    '#resourceGroup':: d.obj(help='"Immutable. The group resource associated with the configuration."'),
    resourceGroup: {
      ...
      '#withResourceType':: d.fn(help='"Immutable. The resource type of the group members. Possible values: RESOURCE_TYPE_UNSPECIFIED, INSTANCE, AWS_ELB_LOAD_BALANCER"', args=[d.arg(name='resourceType', type=d.T.string)]),
