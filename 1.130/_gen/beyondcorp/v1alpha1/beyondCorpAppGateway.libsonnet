{
  ...
  '#':: d.pkg(name='beyondCorpAppGateway', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of BeyondCorpAppGateway', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withDisplayName':: d.fn(help='"Immutable. An arbitrary user-provided name for the AppGateway."', args=[d.arg(name='displayName', type=d.T.string)]),
    withDisplayName(displayName): { spec+: { displayName: displayName } },
    '#withHostType':: d.fn(help='"Immutable. The type of hosting used by the AppGateway. Default value: \\"HOST_TYPE_UNSPECIFIED\\" Possible values: [\\"HOST_TYPE_UNSPECIFIED\\", \\"GCP_REGIONAL_MIG\\"]."', args=[d.arg(name='hostType', type=d.T.string)]),
    withHostType(hostType): { spec+: { hostType: hostType } },
    '#withRegion':: d.fn(help='"Immutable. The region of the AppGateway."', args=[d.arg(name='region', type=d.T.string)]),
    ...
    '#withType':: d.fn(help='"Immutable. The type of network connectivity used by the AppGateway. Default value: \\"TYPE_UNSPECIFIED\\" Possible values: [\\"TYPE_UNSPECIFIED\\", \\"TCP_PROXY\\"]."', args=[d.arg(name='type', type=d.T.string)]),
