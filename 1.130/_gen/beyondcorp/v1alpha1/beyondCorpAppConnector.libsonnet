{
  ...
  '#':: d.pkg(name='beyondCorpAppConnector', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of BeyondCorpAppConnector', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#principalInfo':: d.obj(help='"Principal information about the Identity of the AppConnector."'),
    principalInfo: {
      '#serviceAccount':: d.obj(help='"ServiceAccount represents a GCP service account."'),
      serviceAccount: {
        '#withEmail':: d.fn(help='"Email address of the service account."', args=[d.arg(name='email', type=d.T.string)]),
        withEmail(email): { spec+: { principalInfo+: { serviceAccount+: { email: email } } } },
      },
    },
    ...
    '#withDisplayName':: d.fn(help='"An arbitrary user-provided name for the AppConnector."', args=[d.arg(name='displayName', type=d.T.string)]),
    withDisplayName(displayName): { spec+: { displayName: displayName } },
    '#withRegion':: d.fn(help='"Immutable. The region of the AppConnector."', args=[d.arg(name='region', type=d.T.string)]),
