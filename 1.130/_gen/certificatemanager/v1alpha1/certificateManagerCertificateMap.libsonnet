{
  ...
  '#':: d.pkg(name='certificateManagerCertificateMap', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of CertificateManagerCertificateMap', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
