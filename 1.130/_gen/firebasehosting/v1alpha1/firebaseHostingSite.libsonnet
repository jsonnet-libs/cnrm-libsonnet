{
  ...
  '#':: d.pkg(name='firebaseHostingSite', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of FirebaseHostingSite', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withAppId':: d.fn(help='"Optional. The [ID of a Web App](https://firebase.google.com/docs/reference/firebase-management/rest/v1beta1/projects.webApps#WebApp.FIELDS.app_id)\\nassociated with the Hosting site."', args=[d.arg(name='appId', type=d.T.string)]),
    withAppId(appId): { spec+: { appId: appId } },
    '#withResourceID':: d.fn(help='"Immutable. Optional. The siteId of the resource. Used for creation and acquisition. When unset, the value of `metadata.name` is used as the default."', args=[d.arg(name='resourceID', type=d.T.string)]),
