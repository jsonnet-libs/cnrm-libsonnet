{
  ...
  '#':: d.pkg(name='filestoreSnapshot', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of FilestoreSnapshot', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withDescription':: d.fn(help='"A description of the snapshot with 2048 characters or less. Requests with longer descriptions will be rejected."', args=[d.arg(name='description', type=d.T.string)]),
    withDescription(description): { spec+: { description: description } },
    '#withInstance':: d.fn(help='"Immutable. The resource name of the filestore instance."', args=[d.arg(name='instance', type=d.T.string)]),
    withInstance(instance): { spec+: { instance: instance } },
    '#withLocation':: d.fn(help='"Immutable. The name of the location of the instance. This can be a region for ENTERPRISE tier instances."', args=[d.arg(name='location', type=d.T.string)]),
