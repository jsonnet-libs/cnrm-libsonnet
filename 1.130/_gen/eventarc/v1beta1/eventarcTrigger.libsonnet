{
  ...
  spec: {
    ...
    destination: {
      ...
      '#httpEndpoint':: d.obj(help='"An HTTP endpoint destination described by an URI."'),
      httpEndpoint: {
        '#withUri':: d.fn(help='"Required. The URI of the HTTP enpdoint. The value must be a RFC2396 URI string. Examples: `http://10.10.10.8:80/route`, `http://svc.us-central1.p.local:8080/`. Only HTTP and HTTPS protocols are supported. The host can be either a static IP addressable from the VPC specified by the network config, or an internal DNS hostname of the service resolvable via Cloud DNS."', args=[d.arg(name='uri', type=d.T.string)]),
        withUri(uri): { spec+: { destination+: { httpEndpoint+: { uri: uri } } } },
      },
      '#networkConfig':: d.obj(help='"Optional. Network config is used to configure how Eventarc resolves and connect to a destination. This should only be used with HttpEndpoint destination type."'),
      networkConfig: {
        '#networkAttachmentRef':: d.obj(help=''),
        networkAttachmentRef: {
          '#withExternal':: d.fn(help='"Required. Name of the NetworkAttachment that allows access to the destination VPC. Format: `projects/{PROJECT_ID}/regions/{REGION}/networkAttachments/{NETWORK_ATTACHMENT_NAME}`"', args=[d.arg(name='external', type=d.T.string)]),
          withExternal(external): { spec+: { destination+: { networkConfig+: { networkAttachmentRef+: { external: external } } } } },
          '#withName':: d.fn(help="\"[WARNING] ComputeNetworkAttachment not yet supported in Config Connector, use 'external' field to reference existing resources.\\nName of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names\"", args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { destination+: { networkConfig+: { networkAttachmentRef+: { name: name } } } } },
          '#withNamespace':: d.fn(help='"Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/"', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { spec+: { destination+: { networkConfig+: { networkAttachmentRef+: { namespace: namespace } } } } },
        },
      },
    ...
    '#withEventDataContentType':: d.fn(help='"Optional. EventDataContentType specifies the type of payload in MIME format that is expected from the CloudEvent data field. This is set to `application/json` if the value is not defined."', args=[d.arg(name='eventDataContentType', type=d.T.string)]),
    withEventDataContentType(eventDataContentType): { spec+: { eventDataContentType: eventDataContentType } },
