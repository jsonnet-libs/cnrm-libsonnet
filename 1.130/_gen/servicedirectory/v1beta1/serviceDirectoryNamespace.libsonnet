{
  ...
  '#':: d.pkg(name='serviceDirectoryNamespace', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of ServiceDirectoryNamespace', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withLocation':: d.fn(help="\"Immutable. The location for the Namespace.\\nA full list of valid locations can be found by running\\n'gcloud beta service-directory locations list'.\"", args=[d.arg(name='location', type=d.T.string)]),
    withLocation(location): { spec+: { location: location } },
    '#withResourceID':: d.fn(help='"Immutable. Optional. The namespaceId of the resource. Used for creation and acquisition. When unset, the value of `metadata.name` is used as the default."', args=[d.arg(name='resourceID', type=d.T.string)]),
