{
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#eventTrigger':: d.obj(help='"Immutable. A source that fires events in response to a condition in another service."'),
    eventTrigger: {
      '#resourceRef':: d.obj(help='"Immutable."'),
      resourceRef: {
      ...
      '#withEventType':: d.fn(help="\"Immutable. Required. The type of event to observe. For example:\\n`providers/cloud.storage/eventTypes/object.change` and\\n`providers/cloud.pubsub/eventTypes/topic.publish`.\\n\\nEvent types match pattern `providers/*/eventTypes/*.*`.\\nThe pattern contains:\\n\\n1. namespace: For example, `cloud.storage` and\\n   `google.firebase.analytics`.\\n2. resource type: The type of resource on which event occurs. For\\n   example, the Google Cloud Storage API includes the type `object`.\\n3. action: The action that generates the event. For example, action for\\n   a Google Cloud Storage Object is 'change'.\\nThese parts are lower case.\"", args=[d.arg(name='eventType', type=d.T.string)]),
      withEventType(eventType): { spec+: { eventTrigger+: { eventType: eventType } } },
      '#withFailurePolicy':: d.fn(help='"Immutable. Specifies policy for failed executions."', args=[d.arg(name='failurePolicy', type=d.T.boolean)]),
      withFailurePolicy(failurePolicy): { spec+: { eventTrigger+: { failurePolicy: failurePolicy } } },
      '#withService':: d.fn(help='"Immutable. The hostname of the service that should be observed.\\n\\nIf no string is provided, the default service implementing the API will\\nbe used. For example, `storage.googleapis.com` is the default for all\\nevent types in the `google.storage` namespace."', args=[d.arg(name='service', type=d.T.string)]),
      withService(service): { spec+: { eventTrigger+: { service: service } } },
    },
    '#httpsTrigger':: d.obj(help='"Immutable. An HTTPS endpoint type of source that can be triggered via URL."'),
    httpsTrigger: {
      '#withSecurityLevel':: d.fn(help='"Immutable. Both HTTP and HTTPS requests with URLs that match the handler succeed without redirects. The application can examine the request to determine which protocol was used and respond accordingly. Possible values: SECURITY_LEVEL_UNSPECIFIED, SECURE_ALWAYS, SECURE_OPTIONAL"', args=[d.arg(name='securityLevel', type=d.T.string)]),
    ...
    '#sourceRepository':: d.obj(help='"Immutable. Represents parameters related to source repository where a function is hosted."'),
    sourceRepository: {
      '#withUrl':: d.fn(help='"Immutable. The URL pointing to the hosted repository where the function is defined.\\nThere are supported Cloud Source Repository URLs in the following\\nformats:\\n\\nTo refer to a specific commit:\\n`https://source.developers.google.com/projects/*/repos/*/revisions/*/paths/*`\\nTo refer to a moveable alias (branch):\\n`https://source.developers.google.com/projects/*/repos/*/moveable-aliases/*/paths/*`\\nIn particular, to refer to HEAD use `master` moveable alias.\\nTo refer to a specific fixed alias (tag):\\n`https://source.developers.google.com/projects/*/repos/*/fixed-aliases/*/paths/*`\\n\\nYou may omit `paths/*` if you want to use the main directory."', args=[d.arg(name='url', type=d.T.string)]),
    ...
    '#withRegion':: d.fn(help='"Immutable. The name of the Cloud Functions region of the function."', args=[d.arg(name='region', type=d.T.string)]),
    ...
    '#withSourceArchiveUrl':: d.fn(help='"Immutable. The Google Cloud Storage URL, starting with gs://, pointing to the zip archive which contains the function."', args=[d.arg(name='sourceArchiveUrl', type=d.T.string)]),
