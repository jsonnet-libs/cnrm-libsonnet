{
  ...
  '#':: d.pkg(name='gkeHubFeatureMembership', url='', help='"GKEHubFeatureMembership is the Schema for the gkehub API"'),
  ...
  spec: {
    ...
    configmanagement: {
      '#binauthz':: d.obj(help='"**DEPRECATED** Binauthz configuration for the cluster. This field will be ignored and should not be set."'),
      binauthz: {
      ...
      configSync: {
        ...
        '#metricsGcpServiceAccountRef':: d.obj(help=''),
        metricsGcpServiceAccountRef: {
          '#withExternal':: d.fn(help='"The Email of the Google Cloud Service Account (GSA) used for exporting Config Sync metrics to Cloud Monitoring. The GSA should have the Monitoring Metric Writer(roles/monitoring.metricWriter) IAM role. The Kubernetes ServiceAccount `default` in the namespace `config-management-monitoring` should be bound to the GSA. Allowed value: The `email` field of an `IAMServiceAccount` resource."', args=[d.arg(name='external', type=d.T.string)]),
          withExternal(external): { spec+: { configmanagement+: { configSync+: { metricsGcpServiceAccountRef+: { external: external } } } } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { configmanagement+: { configSync+: { metricsGcpServiceAccountRef+: { name: name } } } } },
          '#withNamespace':: d.fn(help='"Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/"', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { spec+: { configmanagement+: { configSync+: { metricsGcpServiceAccountRef+: { namespace: namespace } } } } },
        },
        '#oci':: d.obj(help=''),
        oci: {
          '#gcpServiceAccountRef':: d.obj(help=''),
          gcpServiceAccountRef: {
            '#withExternal':: d.fn(help='"The `email` field of an `IAMServiceAccount` resource."', args=[d.arg(name='external', type=d.T.string)]),
            withExternal(external): { spec+: { configmanagement+: { configSync+: { oci+: { gcpServiceAccountRef+: { external: external } } } } } },
            '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { configmanagement+: { configSync+: { oci+: { gcpServiceAccountRef+: { name: name } } } } } },
            '#withNamespace':: d.fn(help='"Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/"', args=[d.arg(name='namespace', type=d.T.string)]),
            withNamespace(namespace): { spec+: { configmanagement+: { configSync+: { oci+: { gcpServiceAccountRef+: { namespace: namespace } } } } } },
          },
          '#withPolicyDir':: d.fn(help='"The absolute path of the directory that contains the local resources. Default: the root directory of the image."', args=[d.arg(name='policyDir', type=d.T.string)]),
          withPolicyDir(policyDir): { spec+: { configmanagement+: { configSync+: { oci+: { policyDir: policyDir } } } } },
          '#withSecretType':: d.fn(help='"Type of secret configured for access to the OCI Image. Must be one of gcenode, gcpserviceaccount or none. The validation of this is case-sensitive."', args=[d.arg(name='secretType', type=d.T.string)]),
          withSecretType(secretType): { spec+: { configmanagement+: { configSync+: { oci+: { secretType: secretType } } } } },
          '#withSyncRepo':: d.fn(help='"The OCI image repository URL for the package to sync from. e.g. LOCATION-docker.pkg.dev/PROJECT_ID/REPOSITORY_NAME/PACKAGE_NAME."', args=[d.arg(name='syncRepo', type=d.T.string)]),
          withSyncRepo(syncRepo): { spec+: { configmanagement+: { configSync+: { oci+: { syncRepo: syncRepo } } } } },
          '#withSyncWaitSecs':: d.fn(help='"Period in seconds(int64 format) between consecutive syncs. Default: 15."', args=[d.arg(name='syncWaitSecs', type=d.T.string)]),
          withSyncWaitSecs(syncWaitSecs): { spec+: { configmanagement+: { configSync+: { oci+: { syncWaitSecs: syncWaitSecs } } } } },
        },
      ...
      '#hierarchyController':: d.obj(help='"Hierarchy Controller is no longer available. Use https://github.com/kubernetes-sigs/hierarchical-namespaces instead."'),
      hierarchyController: {
      ...
      '#policyController':: d.obj(help='"**DEPRECATED** Configuring Policy Controller through the configmanagement feature is no longer recommended. Use the policycontroller feature instead."'),
      policyController: {
    ...
    featureRef: {
      '#withExternal':: d.fn(help='"The name of the feature. Allowed value: The Google Cloud resource name of a `GKEHubFeature` resource (format: `projects/{{project}}/locations/{{location}}/features/{{name}}`)."', args=[d.arg(name='external', type=d.T.string)]),
    ...
    membershipRef: {
      '#withExternal':: d.fn(help='"The name of the membership. Allowed value: The Google Cloud resource name of a `GKEHubMembership` resource (format: `projects/{{project}}/locations/{{location}}/memberships/{{name}}`)."', args=[d.arg(name='external', type=d.T.string)]),
    ...
    '#mesh':: d.obj(help='"Manage Mesh Features"'),
    mesh: {
      '#withControlPlane':: d.fn(help='"**DEPRECATED** Whether to automatically manage Service Mesh control planes. Possible values: CONTROL_PLANE_MANAGEMENT_UNSPECIFIED, AUTOMATIC, MANUAL"', args=[d.arg(name='controlPlane', type=d.T.string)]),
      withControlPlane(controlPlane): { spec+: { mesh+: { controlPlane: controlPlane } } },
      '#withManagement':: d.fn(help='"Whether to automatically manage Service Mesh. Possible values: MANAGEMENT_UNSPECIFIED, MANAGEMENT_AUTOMATIC, MANAGEMENT_MANUAL"', args=[d.arg(name='management', type=d.T.string)]),
      withManagement(management): { spec+: { mesh+: { management: management } } },
    },
    '#policycontroller':: d.obj(help='"Policy Controller-specific spec."'),
    policycontroller: {
      '#policyControllerHubConfig':: d.obj(help='"Policy Controller configuration for the cluster."'),
      policyControllerHubConfig: {
        '#monitoring':: d.obj(help='"Specifies the backends Policy Controller should export metrics to. For example, to specify metrics should be exported to Cloud Monitoring and Prometheus, specify backends: [\\"cloudmonitoring\\", \\"prometheus\\"]. Default: [\\"cloudmonitoring\\", \\"prometheus\\"]"'),
        monitoring: {
          '#withBackends':: d.fn(help='"Specifies the list of backends Policy Controller will export to. Specifying an empty value `[]` disables metrics export."', args=[d.arg(name='backends', type=d.T.array)]),
          withBackends(backends): { spec+: { policycontroller+: { policyControllerHubConfig+: { monitoring+: { backends: if std.isArray(v=backends) then backends else [backends] } } } } },
          '#withBackendsMixin':: d.fn(help='"Specifies the list of backends Policy Controller will export to. Specifying an empty value `[]` disables metrics export."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='backends', type=d.T.array)]),
          withBackendsMixin(backends): { spec+: { policycontroller+: { policyControllerHubConfig+: { monitoring+: { backends+: if std.isArray(v=backends) then backends else [backends] } } } } },
        },
        '#policyContent':: d.obj(help='"Specifies the desired policy content on the cluster."'),
        policyContent: {
          '#templateLibrary':: d.obj(help='"Configures the installation of the Template Library."'),
          templateLibrary: {
            '#withInstallation':: d.fn(help='"Configures the manner in which the template library is installed on the cluster. Possible values: INSTALLATION_UNSPECIFIED, NOT_INSTALLED, ALL"', args=[d.arg(name='installation', type=d.T.string)]),
            withInstallation(installation): { spec+: { policycontroller+: { policyControllerHubConfig+: { policyContent+: { templateLibrary+: { installation: installation } } } } } },
          },
        },
        '#withAuditIntervalSeconds':: d.fn(help='"Sets the interval for Policy Controller Audit Scans (in seconds). When set to 0, this disables audit functionality altogether."', args=[d.arg(name='auditIntervalSeconds', type=d.T.integer)]),
        withAuditIntervalSeconds(auditIntervalSeconds): { spec+: { policycontroller+: { policyControllerHubConfig+: { auditIntervalSeconds: auditIntervalSeconds } } } },
        '#withConstraintViolationLimit':: d.fn(help='"The maximum number of audit violations to be stored in a constraint. If not set, the internal default of 20 will be used."', args=[d.arg(name='constraintViolationLimit', type=d.T.integer)]),
        withConstraintViolationLimit(constraintViolationLimit): { spec+: { policycontroller+: { policyControllerHubConfig+: { constraintViolationLimit: constraintViolationLimit } } } },
        '#withExemptableNamespaces':: d.fn(help='"The set of namespaces that are excluded from Policy Controller checks. Namespaces do not need to currently exist on the cluster."', args=[d.arg(name='exemptableNamespaces', type=d.T.array)]),
        withExemptableNamespaces(exemptableNamespaces): { spec+: { policycontroller+: { policyControllerHubConfig+: { exemptableNamespaces: if std.isArray(v=exemptableNamespaces) then exemptableNamespaces else [exemptableNamespaces] } } } },
        '#withExemptableNamespacesMixin':: d.fn(help='"The set of namespaces that are excluded from Policy Controller checks. Namespaces do not need to currently exist on the cluster."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='exemptableNamespaces', type=d.T.array)]),
        withExemptableNamespacesMixin(exemptableNamespaces): { spec+: { policycontroller+: { policyControllerHubConfig+: { exemptableNamespaces+: if std.isArray(v=exemptableNamespaces) then exemptableNamespaces else [exemptableNamespaces] } } } },
        '#withInstallSpec':: d.fn(help='"Configures the mode of the Policy Controller installation. Possible values: INSTALL_SPEC_UNSPECIFIED, INSTALL_SPEC_NOT_INSTALLED, INSTALL_SPEC_ENABLED, INSTALL_SPEC_SUSPENDED, INSTALL_SPEC_DETACHED"', args=[d.arg(name='installSpec', type=d.T.string)]),
        withInstallSpec(installSpec): { spec+: { policycontroller+: { policyControllerHubConfig+: { installSpec: installSpec } } } },
        '#withLogDeniesEnabled':: d.fn(help='"Logs all denies and dry run failures."', args=[d.arg(name='logDeniesEnabled', type=d.T.boolean)]),
        withLogDeniesEnabled(logDeniesEnabled): { spec+: { policycontroller+: { policyControllerHubConfig+: { logDeniesEnabled: logDeniesEnabled } } } },
        '#withMutationEnabled':: d.fn(help='"Enables the ability to mutate resources using Policy Controller."', args=[d.arg(name='mutationEnabled', type=d.T.boolean)]),
        withMutationEnabled(mutationEnabled): { spec+: { policycontroller+: { policyControllerHubConfig+: { mutationEnabled: mutationEnabled } } } },
        '#withReferentialRulesEnabled':: d.fn(help='"Enables the ability to use Constraint Templates that reference to objects other than the object currently being evaluated."', args=[d.arg(name='referentialRulesEnabled', type=d.T.boolean)]),
        withReferentialRulesEnabled(referentialRulesEnabled): { spec+: { policycontroller+: { policyControllerHubConfig+: { referentialRulesEnabled: referentialRulesEnabled } } } },
      },
      '#withVersion':: d.fn(help='"Optional. Version of Policy Controller to install. Defaults to the latest version."', args=[d.arg(name='version', type=d.T.string)]),
      withVersion(version): { spec+: { policycontroller+: { version: version } } },
    },
    '#projectRef':: d.obj(help='"Immutable. The Project that this resource belongs to."'),
    projectRef: {
      '#withExternal':: d.fn(help='"The project of the feature. Allowed value: The Google Cloud resource name of a `Project` resource (format: `projects/{{name}}`)."', args=[d.arg(name='external', type=d.T.string)]),
    ...
    '#withMembershipLocation':: d.fn(help='"Immutable. The location of the membership"', args=[d.arg(name='membershipLocation', type=d.T.string)]),
    withMembershipLocation(membershipLocation): { spec+: { membershipLocation: membershipLocation } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
