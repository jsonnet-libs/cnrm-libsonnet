{
  ...
  spec: {
    ...
    externalDataConfiguration: {
      '#avroOptions':: d.obj(help='"Additional options if source_format is set to \\"AVRO\\"."'),
      avroOptions: {
        '#withUseAvroLogicalTypes':: d.fn(help='"If sourceFormat is set to \\"AVRO\\", indicates whether to interpret logical types as the corresponding BigQuery data type (for example, TIMESTAMP), instead of using the raw type (for example, INTEGER)."', args=[d.arg(name='useAvroLogicalTypes', type=d.T.boolean)]),
        withUseAvroLogicalTypes(useAvroLogicalTypes): { spec+: { externalDataConfiguration+: { avroOptions+: { useAvroLogicalTypes: useAvroLogicalTypes } } } },
      },
      ...
      '#jsonOptions':: d.obj(help='"Additional properties to set if sourceFormat is set to JSON.\\"."'),
      jsonOptions: {
        ...
        withEncoding(encoding): { spec+: { externalDataConfiguration+: { jsonOptions+: { encoding: encoding } } } },
      },
      '#parquetOptions':: d.obj(help='"Additional properties to set if sourceFormat is set to PARQUET.\\"."'),
      parquetOptions: {
        ...
        withEnableListInference(enableListInference): { spec+: { externalDataConfiguration+: { parquetOptions+: { enableListInference: enableListInference } } } },
        ...
        withEnumAsString(enumAsString): { spec+: { externalDataConfiguration+: { parquetOptions+: { enumAsString: enumAsString } } } },
      },
      ...
      '#withConnectionId':: d.fn(help='"The connection specifying the credentials to be used to read external storage, such as Azure Blob, Cloud Storage, or S3. The connectionId can have the form \\"{{project}}.{{location}}.{{connection_id}}\\" or \\"projects/{{project}}/locations/{{location}}/connections/{{connection_id}}\\"."', args=[d.arg(name='connectionId', type=d.T.string)]),
      withConnectionId(connectionId): { spec+: { externalDataConfiguration+: { connectionId: connectionId } } },
      '#withFileSetSpecType':: d.fn(help='"Specifies how source URIs are interpreted for constructing the file set to load.  By default source URIs are expanded against the underlying storage.  Other options include specifying manifest files. Only applicable to object storage systems."', args=[d.arg(name='fileSetSpecType', type=d.T.string)]),
      withFileSetSpecType(fileSetSpecType): { spec+: { externalDataConfiguration+: { fileSetSpecType: fileSetSpecType } } },
      ...
      '#withMetadataCacheMode':: d.fn(help='"Metadata Cache Mode for the table. Set this to enable caching of metadata from external data source."', args=[d.arg(name='metadataCacheMode', type=d.T.string)]),
      withMetadataCacheMode(metadataCacheMode): { spec+: { externalDataConfiguration+: { metadataCacheMode: metadataCacheMode } } },
      '#withObjectMetadata':: d.fn(help='"Object Metadata is used to create Object Tables. Object Tables contain a listing of objects (with their metadata) found at the sourceUris. If ObjectMetadata is set, sourceFormat should be omitted."', args=[d.arg(name='objectMetadata', type=d.T.string)]),
      withObjectMetadata(objectMetadata): { spec+: { externalDataConfiguration+: { objectMetadata: objectMetadata } } },
      ...
      withReferenceFileSchemaUri(referenceFileSchemaUri): { spec+: { externalDataConfiguration+: { referenceFileSchemaUri: referenceFileSchemaUri } } },
      ...
      '#withSourceFormat':: d.fn(help="\" Please see sourceFormat under ExternalDataConfiguration in Bigquery's public API documentation (https://cloud.google.com/bigquery/docs/reference/rest/v2/tables#externaldataconfiguration) for supported formats. To use \\\"GOOGLE_SHEETS\\\" the scopes must include \\\"googleapis.com/auth/drive.readonly\\\".\"", args=[d.arg(name='sourceFormat', type=d.T.string)]),
    ...
    materializedView: {
      '#withAllowNonIncrementalDefinition':: d.fn(help='"Immutable. Allow non incremental materialized view definition. The default value is false."', args=[d.arg(name='allowNonIncrementalDefinition', type=d.T.boolean)]),
      withAllowNonIncrementalDefinition(allowNonIncrementalDefinition): { spec+: { materializedView+: { allowNonIncrementalDefinition: allowNonIncrementalDefinition } } },
    ...
    tableConstraints: {
      '#foreignKeys':: d.obj(help='"Present only if the table has a foreign key. The foreign key is not enforced."'),
      foreignKeys: {
        '#columnReferences':: d.obj(help='"The pair of the foreign key column and primary key column."'),
        columnReferences: {
          '#withReferencedColumn':: d.fn(help='"The column in the primary key that are referenced by the referencingColumn."', args=[d.arg(name='referencedColumn', type=d.T.string)]),
        ...
        '#referencedTable':: d.obj(help='"The table that holds the primary key and is referenced by this foreign key."'),
        referencedTable: {
          ...
          '#withTableId':: d.fn(help='"The ID of the table. The ID must contain only letters (a-z, A-Z), numbers (0-9), or underscores (_). The maximum length is 1,024 characters. Certain operations allow suffixing of the table ID with a partition decorator, such as sample_table$20190123."', args=[d.arg(name='tableId', type=d.T.string)]),
      ...
      '#primaryKey':: d.obj(help="\"Represents a primary key constraint on a table's columns. Present only if the table has a primary key. The primary key is not enforced.\""),
      primaryKey: {
        '#withColumns':: d.fn(help='"The columns that are composed of the primary key constraint."', args=[d.arg(name='columns', type=d.T.array)]),
        withColumns(columns): { spec+: { tableConstraints+: { primaryKey+: { columns: if std.isArray(v=columns) then columns else [columns] } } } },
        ...
        withColumnsMixin(columns): { spec+: { tableConstraints+: { primaryKey+: { columns+: if std.isArray(v=columns) then columns else [columns] } } } },
      },
      '#withForeignKeys':: d.fn(help='"Present only if the table has a foreign key. The foreign key is not enforced."', args=[d.arg(name='foreignKeys', type=d.T.array)]),
      withForeignKeys(foreignKeys): { spec+: { tableConstraints+: { foreignKeys: if std.isArray(v=foreignKeys) then foreignKeys else [foreignKeys] } } },
      '#withForeignKeysMixin':: d.fn(help='"Present only if the table has a foreign key. The foreign key is not enforced."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='foreignKeys', type=d.T.array)]),
      withForeignKeysMixin(foreignKeys): { spec+: { tableConstraints+: { foreignKeys+: if std.isArray(v=foreignKeys) then foreignKeys else [foreignKeys] } } },
    },
    ...
    timePartitioning: {
      ...
      '#withRequirePartitionFilter':: d.fn(help='"DEPRECATED. This field is deprecated; please use the top level field with the same name instead. If set to true, queries over this table require a partition filter that can be used for partition elimination to be specified."', args=[d.arg(name='requirePartitionFilter', type=d.T.boolean)]),
    ...
    '#withMaxStaleness':: d.fn(help='"The maximum staleness of data that could be returned when the table (or stale MV) is queried. Staleness encoded as a string encoding of sql IntervalValue type."', args=[d.arg(name='maxStaleness', type=d.T.string)]),
    withMaxStaleness(maxStaleness): { spec+: { maxStaleness: maxStaleness } },
    '#withRequirePartitionFilter':: d.fn(help='"If set to true, queries over this table require a partition filter that can be used for partition elimination to be specified."', args=[d.arg(name='requirePartitionFilter', type=d.T.boolean)]),
    withRequirePartitionFilter(requirePartitionFilter): { spec+: { requirePartitionFilter: requirePartitionFilter } },
