{
  ...
  spec: {
    ...
    approvalConfig: {
      ...
      withApprovalRequired(approvalRequired): { spec+: { approvalConfig+: { approvalRequired: approvalRequired } } },
    },
    ...
    bitbucketServerTriggerConfig: {
      '#bitbucketServerConfigResourceRef':: d.obj(help='"Only `external` field is supported to configure the reference.\\n\\nThe full resource name of the bitbucket server config. Format:\\nprojects/{project}/locations/{location}/bitbucketServerConfigs/{id}."'),
      bitbucketServerConfigResourceRef: {
        '#withExternal':: d.fn(help='"Allowed value: The `name` field of a `CloudBuildBitbucketServerConfig` resource."', args=[d.arg(name='external', type=d.T.string)]),
        withExternal(external): { spec+: { bitbucketServerTriggerConfig+: { bitbucketServerConfigResourceRef+: { external: external } } } },
        '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { bitbucketServerTriggerConfig+: { bitbucketServerConfigResourceRef+: { name: name } } } },
        ...
        withNamespace(namespace): { spec+: { bitbucketServerTriggerConfig+: { bitbucketServerConfigResourceRef+: { namespace: namespace } } } },
      },
      '#pullRequest':: d.obj(help='"Filter to match changes in pull requests."'),
      pullRequest: {
        '#withBranch':: d.fn(help='"Regex of branches to match.\\nThe syntax of the regular expressions accepted is the syntax accepted by RE2 and described at https://github.com/google/re2/wiki/Syntax."', args=[d.arg(name='branch', type=d.T.string)]),
        withBranch(branch): { spec+: { bitbucketServerTriggerConfig+: { pullRequest+: { branch: branch } } } },
        '#withCommentControl':: d.fn(help='"Configure builds to run whether a repository owner or collaborator need to comment /gcbrun. Possible values: [\\"COMMENTS_DISABLED\\", \\"COMMENTS_ENABLED\\", \\"COMMENTS_ENABLED_FOR_EXTERNAL_CONTRIBUTORS_ONLY\\"]."', args=[d.arg(name='commentControl', type=d.T.string)]),
        withCommentControl(commentControl): { spec+: { bitbucketServerTriggerConfig+: { pullRequest+: { commentControl: commentControl } } } },
        ...
        withInvertRegex(invertRegex): { spec+: { bitbucketServerTriggerConfig+: { pullRequest+: { invertRegex: invertRegex } } } },
      },
      ...
      push: {
        ...
        withBranch(branch): { spec+: { bitbucketServerTriggerConfig+: { push+: { branch: branch } } } },
        '#withInvertRegex':: d.fn(help='"When true, only trigger a build if the revision regex does NOT match the gitRef regex."', args=[d.arg(name='invertRegex', type=d.T.boolean)]),
        withInvertRegex(invertRegex): { spec+: { bitbucketServerTriggerConfig+: { push+: { invertRegex: invertRegex } } } },
        '#withTag':: d.fn(help='"Regex of tags to match.  Specify only one of branch or tag."', args=[d.arg(name='tag', type=d.T.string)]),
        withTag(tag): { spec+: { bitbucketServerTriggerConfig+: { push+: { tag: tag } } } },
      },
      ...
      withProjectKey(projectKey): { spec+: { bitbucketServerTriggerConfig+: { projectKey: projectKey } } },
      ...
      withRepoSlug(repoSlug): { spec+: { bitbucketServerTriggerConfig+: { repoSlug: repoSlug } } },
    },
    ...
    build: {
      ...
      options: {
        ...
        '#withLogging':: d.fn(help='"Option to specify the logging mode, which determines if and where build logs are stored. Possible values: [\\"LOGGING_UNSPECIFIED\\", \\"LEGACY\\", \\"GCS_ONLY\\", \\"STACKDRIVER_ONLY\\", \\"CLOUD_LOGGING_ONLY\\", \\"NONE\\"]."', args=[d.arg(name='logging', type=d.T.string)]),
    ...
    gitFileSource: {
      '#bitbucketServerConfigRef':: d.obj(help='"Only `external` field is supported to configure the reference.\\n\\nThe full resource name of the bitbucket server config. Format:\\nprojects/{project}/locations/{location}/bitbucketServerConfigs/{id}."'),
      bitbucketServerConfigRef: {
        '#withExternal':: d.fn(help='"Allowed value: The `name` field of a `CloudBuildBitbucketServerConfig` resource."', args=[d.arg(name='external', type=d.T.string)]),
        withExternal(external): { spec+: { gitFileSource+: { bitbucketServerConfigRef+: { external: external } } } },
        '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { gitFileSource+: { bitbucketServerConfigRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { gitFileSource+: { bitbucketServerConfigRef+: { namespace: namespace } } } },
      },
      '#githubEnterpriseConfigRef':: d.obj(help='"Only `external` field is supported to configure the reference.\\n\\nThe full resource name of the github enterprise config. Format:\\nprojects/{project}/locations/{location}/githubEnterpriseConfigs/{id}."'),
      githubEnterpriseConfigRef: {
        '#withExternal':: d.fn(help='"Allowed value: The `name` field of a `CloudBuildGithubEnterpriseConfig` resource."', args=[d.arg(name='external', type=d.T.string)]),
        withExternal(external): { spec+: { gitFileSource+: { githubEnterpriseConfigRef+: { external: external } } } },
        '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { gitFileSource+: { githubEnterpriseConfigRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { gitFileSource+: { githubEnterpriseConfigRef+: { namespace: namespace } } } },
      },
      '#repositoryRef':: d.obj(help='"Only `external` field is supported to configure the reference.\\n\\nThe fully qualified resource name of the Repo API repository. The fully qualified resource name of the Repo API repository.\\nIf unspecified, the repo from which the trigger invocation originated is assumed to be the repo from which to read the specified path."'),
      repositoryRef: {
        '#withExternal':: d.fn(help='"Allowed value: The `name` field of a `CloudBuildV2Repository` resource."', args=[d.arg(name='external', type=d.T.string)]),
        withExternal(external): { spec+: { gitFileSource+: { repositoryRef+: { external: external } } } },
        '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { gitFileSource+: { repositoryRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { gitFileSource+: { repositoryRef+: { namespace: namespace } } } },
      },
      ...
      '#withRepoType':: d.fn(help='"The type of the repo, since it may not be explicit from the repo field (e.g from a URL).\\nValues can be UNKNOWN, CLOUD_SOURCE_REPOSITORIES, GITHUB, BITBUCKET_SERVER Possible values: [\\"UNKNOWN\\", \\"CLOUD_SOURCE_REPOSITORIES\\", \\"GITHUB\\", \\"BITBUCKET_SERVER\\"]."', args=[d.arg(name='repoType', type=d.T.string)]),
    ...
    github: {
      '#enterpriseConfigResourceNameRef':: d.obj(help='"Only `external` field is supported to configure the reference.\\n\\nThe full resource name of the github enterprise config. Format:\\nprojects/{project}/locations/{location}/githubEnterpriseConfigs/{id}."'),
      enterpriseConfigResourceNameRef: {
        '#withExternal':: d.fn(help='"Allowed value: The `name` field of a `CloudBuildGithubEnterpriseConfig` resource."', args=[d.arg(name='external', type=d.T.string)]),
        withExternal(external): { spec+: { github+: { enterpriseConfigResourceNameRef+: { external: external } } } },
        '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { github+: { enterpriseConfigResourceNameRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { github+: { enterpriseConfigResourceNameRef+: { namespace: namespace } } } },
      },
    ...
    repositoryEventConfig: {
      ...
      pullRequest: {
        ...
        withBranch(branch): { spec+: { repositoryEventConfig+: { pullRequest+: { branch: branch } } } },
        '#withCommentControl':: d.fn(help="\"Configure builds to run whether a repository owner or collaborator need to comment '/gcbrun'. Possible values: [\\\"COMMENTS_DISABLED\\\", \\\"COMMENTS_ENABLED\\\", \\\"COMMENTS_ENABLED_FOR_EXTERNAL_CONTRIBUTORS_ONLY\\\"].\"", args=[d.arg(name='commentControl', type=d.T.string)]),
        withCommentControl(commentControl): { spec+: { repositoryEventConfig+: { pullRequest+: { commentControl: commentControl } } } },
        '#withInvertRegex':: d.fn(help='"If true, branches that do NOT match the git_ref will trigger a build."', args=[d.arg(name='invertRegex', type=d.T.boolean)]),
        withInvertRegex(invertRegex): { spec+: { repositoryEventConfig+: { pullRequest+: { invertRegex: invertRegex } } } },
      },
      '#push':: d.obj(help='"Contains filter properties for matching git pushes."'),
      push: {
        '#withBranch':: d.fn(help='"Regex of branches to match.\\n\\nThe syntax of the regular expressions accepted is the syntax accepted by\\nRE2 and described at https://github.com/google/re2/wiki/Syntax."', args=[d.arg(name='branch', type=d.T.string)]),
        withBranch(branch): { spec+: { repositoryEventConfig+: { push+: { branch: branch } } } },
        '#withInvertRegex':: d.fn(help='"If true, only trigger a build if the revision regex does NOT match the git_ref regex."', args=[d.arg(name='invertRegex', type=d.T.boolean)]),
        withInvertRegex(invertRegex): { spec+: { repositoryEventConfig+: { push+: { invertRegex: invertRegex } } } },
        ...
        withTag(tag): { spec+: { repositoryEventConfig+: { push+: { tag: tag } } } },
      },
      '#withRepository':: d.fn(help='"The resource name of the Repo API resource."', args=[d.arg(name='repository', type=d.T.string)]),
      withRepository(repository): { spec+: { repositoryEventConfig+: { repository: repository } } },
    },
    ...
    sourceToBuild: {
      ...
      bitbucketServerConfigRef: {
        '#withExternal':: d.fn(help='"Allowed value: The `name` field of a `CloudBuildBitbucketServerConfig` resource."', args=[d.arg(name='external', type=d.T.string)]),
        withExternal(external): { spec+: { sourceToBuild+: { bitbucketServerConfigRef+: { external: external } } } },
        '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { sourceToBuild+: { bitbucketServerConfigRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { sourceToBuild+: { bitbucketServerConfigRef+: { namespace: namespace } } } },
      },
      '#githubEnterpriseConfigRef':: d.obj(help='"Only `external` field is supported to configure the reference.\\n\\nThe full resource name of the github enterprise config. Format:\\nprojects/{project}/locations/{location}/githubEnterpriseConfigs/{id}."'),
      githubEnterpriseConfigRef: {
        '#withExternal':: d.fn(help='"Allowed value: The `name` field of a `CloudBuildGithubEnterpriseConfig` resource."', args=[d.arg(name='external', type=d.T.string)]),
        withExternal(external): { spec+: { sourceToBuild+: { githubEnterpriseConfigRef+: { external: external } } } },
        '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { sourceToBuild+: { githubEnterpriseConfigRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { sourceToBuild+: { githubEnterpriseConfigRef+: { namespace: namespace } } } },
      },
      '#repositoryRef':: d.obj(help='"Only `external` field is supported to configure the reference.\\n\\nThe qualified resource name of the Repo API repository.\\nEither uri or repository can be specified and is required."'),
      repositoryRef: {
        '#withExternal':: d.fn(help='"Allowed value: The `name` field of a `CloudBuildV2Repository` resource."', args=[d.arg(name='external', type=d.T.string)]),
        withExternal(external): { spec+: { sourceToBuild+: { repositoryRef+: { external: external } } } },
        '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { sourceToBuild+: { repositoryRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { sourceToBuild+: { repositoryRef+: { namespace: namespace } } } },
      },
    ...
    '#withIncludeBuildLogs':: d.fn(help='"Build logs will be sent back to GitHub as part of the checkrun\\nresult.  Values can be INCLUDE_BUILD_LOGS_UNSPECIFIED or\\nINCLUDE_BUILD_LOGS_WITH_STATUS Possible values: [\\"INCLUDE_BUILD_LOGS_UNSPECIFIED\\", \\"INCLUDE_BUILD_LOGS_WITH_STATUS\\"]."', args=[d.arg(name='includeBuildLogs', type=d.T.string)]),
    withIncludeBuildLogs(includeBuildLogs): { spec+: { includeBuildLogs: includeBuildLogs } },
    ...
    '#withLocation':: d.fn(help='"Immutable. The [Cloud Build location](https://cloud.google.com/build/docs/locations) for the trigger.\\nIf not specified, \\"global\\" is used."', args=[d.arg(name='location', type=d.T.string)]),
