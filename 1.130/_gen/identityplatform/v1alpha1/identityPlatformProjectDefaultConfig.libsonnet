{
  ...
  '#':: d.pkg(name='identityPlatformProjectDefaultConfig', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of IdentityPlatformProjectDefaultConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    signIn: {
      ...
      email: {
        ...
        '#withPasswordRequired':: d.fn(help='"Whether a password is required for email auth or not. If true, both an email and\\npassword must be provided to sign in. If false, a user may sign in via either\\nemail/password or email link."', args=[d.arg(name='passwordRequired', type=d.T.boolean)]),
        withPasswordRequired(passwordRequired): { spec+: { signIn+: { email+: { passwordRequired: passwordRequired } } } },
      },
      '#hashConfig':: d.obj(help='"Output only. Hash config information."'),
      hashConfig: {
        '#withAlgorithm':: d.fn(help='"Different password hash algorithms used in Identity Toolkit."', args=[d.arg(name='algorithm', type=d.T.string)]),
        withAlgorithm(algorithm): { algorithm: algorithm },
        '#withMemoryCost':: d.fn(help='"Memory cost for hash calculation. Used by scrypt and other similar password derivation algorithms. See https://tools.ietf.org/html/rfc7914 for explanation of field."', args=[d.arg(name='memoryCost', type=d.T.integer)]),
        withMemoryCost(memoryCost): { memoryCost: memoryCost },
        '#withRounds':: d.fn(help='"How many rounds for hash calculation. Used by scrypt and other similar password derivation algorithms."', args=[d.arg(name='rounds', type=d.T.integer)]),
        withRounds(rounds): { rounds: rounds },
        '#withSaltSeparator':: d.fn(help='"Non-printable character to be inserted between the salt and plain text password in base64."', args=[d.arg(name='saltSeparator', type=d.T.string)]),
        withSaltSeparator(saltSeparator): { saltSeparator: saltSeparator },
        '#withSignerKey':: d.fn(help='"Signer key in base64."', args=[d.arg(name='signerKey', type=d.T.string)]),
        withSignerKey(signerKey): { signerKey: signerKey },
      },
      ...
      phoneNumber: {
        ...
        '#withTestPhoneNumbers':: d.fn(help='"A map of <test phone number, fake code> that can be used for phone auth testing."', args=[d.arg(name='testPhoneNumbers', type=d.T.object)]),
        withTestPhoneNumbers(testPhoneNumbers): { spec+: { signIn+: { phoneNumber+: { testPhoneNumbers: testPhoneNumbers } } } },
        '#withTestPhoneNumbersMixin':: d.fn(help='"A map of <test phone number, fake code> that can be used for phone auth testing."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='testPhoneNumbers', type=d.T.object)]),
      ...
      '#withHashConfig':: d.fn(help='"Output only. Hash config information."', args=[d.arg(name='hashConfig', type=d.T.array)]),
      withHashConfig(hashConfig): { spec+: { signIn+: { hashConfig: if std.isArray(v=hashConfig) then hashConfig else [hashConfig] } } },
      '#withHashConfigMixin':: d.fn(help='"Output only. Hash config information."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='hashConfig', type=d.T.array)]),
      withHashConfigMixin(hashConfig): { spec+: { signIn+: { hashConfig+: if std.isArray(v=hashConfig) then hashConfig else [hashConfig] } } },
    },
