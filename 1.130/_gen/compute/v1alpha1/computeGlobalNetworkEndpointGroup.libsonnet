{
  ...
  '#':: d.pkg(name='computeGlobalNetworkEndpointGroup', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of ComputeGlobalNetworkEndpointGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withNetworkEndpointType':: d.fn(help='"Immutable. Type of network endpoints in this network endpoint group. Possible values: [\\"INTERNET_IP_PORT\\", \\"INTERNET_FQDN_PORT\\"]."', args=[d.arg(name='networkEndpointType', type=d.T.string)]),
