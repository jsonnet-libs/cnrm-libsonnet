{
  ...
  '#':: d.pkg(name='computeDiskResourcePolicyAttachment', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of ComputeDiskResourcePolicyAttachment', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withZone':: d.fn(help='"Immutable. A reference to the zone where the disk resides."', args=[d.arg(name='zone', type=d.T.string)]),
