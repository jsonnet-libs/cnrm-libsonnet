{
  ...
  '#':: d.pkg(name='computeBackendServiceSignedURLKey', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of ComputeBackendServiceSignedURLKey', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#keyValue':: d.obj(help='"Immutable. 128-bit key value used for signing the URL. The key value must be a\\nvalid RFC 4648 Section 5 base64url encoded string."'),
    keyValue: {
