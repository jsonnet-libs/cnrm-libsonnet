{
  ...
  '#':: d.pkg(name='computeBackendBucketSignedURLKey', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of ComputeBackendBucketSignedURLKey', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    backendBucketRef: {
      '#withExternal':: d.fn(help='"Allowed value: The `name` field of a `ComputeBackendBucket` resource."', args=[d.arg(name='external', type=d.T.string)]),
      withExternal(external): { spec+: { backendBucketRef+: { external: external } } },
      '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { backendBucketRef+: { name: name } } },
      ...
      withNamespace(namespace): { spec+: { backendBucketRef+: { namespace: namespace } } },
    },
