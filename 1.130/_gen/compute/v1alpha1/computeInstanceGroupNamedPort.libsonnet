{
  ...
  '#':: d.pkg(name='computeInstanceGroupNamedPort', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of ComputeInstanceGroupNamedPort', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    '#groupRef':: d.obj(help=''),
    groupRef: {
      '#withExternal':: d.fn(help='"Allowed value: The `name` field of a `ComputeInstanceGroup` resource."', args=[d.arg(name='external', type=d.T.string)]),
    ...
    '#withZone':: d.fn(help='"Immutable. The zone of the instance group."', args=[d.arg(name='zone', type=d.T.string)]),
