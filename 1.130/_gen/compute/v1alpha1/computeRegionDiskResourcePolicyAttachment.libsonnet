{
  ...
  '#':: d.pkg(name='computeRegionDiskResourcePolicyAttachment', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of ComputeRegionDiskResourcePolicyAttachment', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withRegion':: d.fn(help='"Immutable. A reference to the region where the disk resides."', args=[d.arg(name='region', type=d.T.string)]),
