{
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#diskConsistencyGroupPolicy':: d.obj(help='"Immutable. Replication consistency group for asynchronous disk replication."'),
    diskConsistencyGroupPolicy: {
      '#withEnabled':: d.fn(help='"Immutable. Enable disk consistency on the resource policy."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { diskConsistencyGroupPolicy+: { enabled: enabled } } },
    },
    ...
    groupPlacementPolicy: {
      ...
      '#withMaxDistance':: d.fn(help='"Immutable. Specifies the number of max logical switches."', args=[d.arg(name='maxDistance', type=d.T.integer)]),
      withMaxDistance(maxDistance): { spec+: { groupPlacementPolicy+: { maxDistance: maxDistance } } },
    ...
    snapshotSchedulePolicy: {
      ...
      schedule: {
        ...
        dailySchedule: {
          '#withDaysInCycle':: d.fn(help='"Immutable. Defines a schedule with units measured in days. The value determines how many days pass between the start of each cycle. Days in cycle for snapshot schedule policy must be 1."', args=[d.arg(name='daysInCycle', type=d.T.integer)]),
