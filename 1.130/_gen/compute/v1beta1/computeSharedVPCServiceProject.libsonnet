{
  ...
  spec: {
    ...
    '#withDeletionPolicy':: d.fn(help='"The deletion policy for the shared VPC service. Setting ABANDON allows the resource\\n\\t\\t\\t\\tto be abandoned rather than deleted. Possible values are: \\"ABANDON\\"."', args=[d.arg(name='deletionPolicy', type=d.T.string)]),
