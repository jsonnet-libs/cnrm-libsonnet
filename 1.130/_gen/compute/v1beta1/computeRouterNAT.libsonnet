{
  ...
  spec: {
    ...
    '#rules':: d.obj(help='"A list of rules associated with this NAT."'),
    rules: {
      '#action':: d.obj(help='"The action to be enforced for traffic that matches this rule."'),
      action: {
        '#sourceNatActiveIpsRefs':: d.obj(help=''),
        ...
        '#sourceNatDrainIpsRefs':: d.obj(help=''),
        ...
        '#withSourceNatActiveIpsRefs':: d.fn(help='', args=[d.arg(name='sourceNatActiveIpsRefs', type=d.T.array)]),
        withSourceNatActiveIpsRefs(sourceNatActiveIpsRefs): { action+: { sourceNatActiveIpsRefs: if std.isArray(v=sourceNatActiveIpsRefs) then sourceNatActiveIpsRefs else [sourceNatActiveIpsRefs] } },
        '#withSourceNatActiveIpsRefsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sourceNatActiveIpsRefs', type=d.T.array)]),
        withSourceNatActiveIpsRefsMixin(sourceNatActiveIpsRefs): { action+: { sourceNatActiveIpsRefs+: if std.isArray(v=sourceNatActiveIpsRefs) then sourceNatActiveIpsRefs else [sourceNatActiveIpsRefs] } },
        '#withSourceNatDrainIpsRefs':: d.fn(help='', args=[d.arg(name='sourceNatDrainIpsRefs', type=d.T.array)]),
        withSourceNatDrainIpsRefs(sourceNatDrainIpsRefs): { action+: { sourceNatDrainIpsRefs: if std.isArray(v=sourceNatDrainIpsRefs) then sourceNatDrainIpsRefs else [sourceNatDrainIpsRefs] } },
        '#withSourceNatDrainIpsRefsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sourceNatDrainIpsRefs', type=d.T.array)]),
        withSourceNatDrainIpsRefsMixin(sourceNatDrainIpsRefs): { action+: { sourceNatDrainIpsRefs+: if std.isArray(v=sourceNatDrainIpsRefs) then sourceNatDrainIpsRefs else [sourceNatDrainIpsRefs] } },
      },
      ...
      '#withMatch':: d.fn(help="\"CEL expression that specifies the match condition that egress traffic from a VM is evaluated against.\\nIf it evaluates to true, the corresponding action is enforced.\\n\\nThe following examples are valid match expressions for public NAT:\\n\\n\\\"inIpRange(destination.ip, '1.1.0.0/16') || inIpRange(destination.ip, '2.2.0.0/16')\\\"\\n\\n\\\"destination.ip == '1.1.0.1' || destination.ip == '8.8.8.8'\\\"\\n\\nThe following example is a valid match expression for private NAT:\\n\\n\\\"nexthop.hub == 'https://networkconnectivity.googleapis.com/v1alpha1/projects/my-project/global/hub/hub-1'\\\".\"", args=[d.arg(name='match', type=d.T.string)]),
      withMatch(match): { match: match },
      '#withRuleNumber':: d.fn(help='"An integer uniquely identifying a rule in the list.\\nThe rule number must be a positive value between 0 and 65000, and must be unique among rules within a NAT."', args=[d.arg(name='ruleNumber', type=d.T.integer)]),
    ...
    '#withTcpTimeWaitTimeoutSec':: d.fn(help='"Timeout (in seconds) for TCP connections that are in TIME_WAIT state.\\nDefaults to 120s if not set."', args=[d.arg(name='tcpTimeWaitTimeoutSec', type=d.T.integer)]),
    withTcpTimeWaitTimeoutSec(tcpTimeWaitTimeoutSec): { spec+: { tcpTimeWaitTimeoutSec: tcpTimeWaitTimeoutSec } },
