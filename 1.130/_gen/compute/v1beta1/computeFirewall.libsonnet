{
  ...
  spec: {
    ...
    '#withDestinationRanges':: d.fn(help='"If destination ranges are specified, the firewall will apply only to\\ntraffic that has destination IP address in these ranges. These ranges\\nmust be expressed in CIDR format. IPv4 or IPv6 ranges are supported."', args=[d.arg(name='destinationRanges', type=d.T.array)]),
