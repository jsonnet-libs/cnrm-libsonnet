{
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#urlMapRef':: d.obj(help='"The UrlMap resource that defines the mapping from URL to the BackendService.\\nThe protocol field in the BackendService must be set to GRPC."'),
    urlMapRef: {
    ...
    '#withValidateForProxyless':: d.fn(help='"Immutable. If true, indicates that the BackendServices referenced by\\nthe urlMap may be accessed by gRPC applications without using\\na sidecar proxy. This will enable configuration checks on urlMap\\nand its referenced BackendServices to not allow unsupported features.\\nA gRPC application must use \\"xds:///\\" scheme in the target URI\\nof the service it is connecting to. If false, indicates that the\\nBackendServices referenced by the urlMap will be accessed by gRPC\\napplications via a sidecar proxy. In this case, a gRPC application\\nmust not use \\"xds:///\\" scheme in the target URI of the service\\nit is connecting to."', args=[d.arg(name='validateForProxyless', type=d.T.boolean)]),
    withValidateForProxyless(validateForProxyless): { spec+: { validateForProxyless: validateForProxyless } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
