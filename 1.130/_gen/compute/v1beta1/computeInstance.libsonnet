{
  ...
  spec: {
    ...
    bootDisk: {
      ...
      initializeParams: {
        '#sourceImageRef':: d.obj(help='"Immutable. The image from which to initialize this disk."'),
        sourceImageRef: {
        ...
        '#withResourceManagerTags':: d.fn(help='"Immutable. A map of resource manager tags. Resource manager tag keys and values have the same definition as resource manager tags. Keys must be in the format tagKeys/{tag_key_id}, and values are in the format tagValues/456. The field is ignored (both PUT & PATCH) when empty."', args=[d.arg(name='resourceManagerTags', type=d.T.object)]),
        withResourceManagerTags(resourceManagerTags): { spec+: { bootDisk+: { initializeParams+: { resourceManagerTags: resourceManagerTags } } } },
        '#withResourceManagerTagsMixin':: d.fn(help='"Immutable. A map of resource manager tags. Resource manager tag keys and values have the same definition as resource manager tags. Keys must be in the format tagKeys/{tag_key_id}, and values are in the format tagValues/456. The field is ignored (both PUT & PATCH) when empty."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='resourceManagerTags', type=d.T.object)]),
        withResourceManagerTagsMixin(resourceManagerTags): { spec+: { bootDisk+: { initializeParams+: { resourceManagerTags+: resourceManagerTags } } } },
        ...
        '#withType':: d.fn(help='"Immutable. The Google Compute Engine disk type. Such as pd-standard, pd-ssd or pd-balanced."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#sourceDiskRef':: d.obj(help='"Immutable. The source disk used to create this disk."'),
      sourceDiskRef: {
        '#withExternal':: d.fn(help='"Allowed value: The `selfLink` field of a `ComputeDisk` resource."', args=[d.arg(name='external', type=d.T.string)]),
    ...
    guestAccelerator: {
      ...
      '#withType':: d.fn(help='"Immutable. The accelerator type resource exposed to this instance. E.g. nvidia-tesla-t4."', args=[d.arg(name='type', type=d.T.string)]),
    ...
    networkInterface: {
      ...
      ipv6AccessConfig: {
        '#withExternalIpv6':: d.fn(help="\"Immutable. The first IPv6 address of the external IPv6 range associated with this instance, prefix length is stored in externalIpv6PrefixLength in ipv6AccessConfig. To use a static external IP address, it must be unused and in the same region as the instance's zone. If not specified, Google Cloud will automatically assign an external IPv6 address from the instance's subnetwork.\"", args=[d.arg(name='externalIpv6', type=d.T.string)]),
        withExternalIpv6(externalIpv6): { externalIpv6: externalIpv6 },
        '#withExternalIpv6PrefixLength':: d.fn(help='"Immutable. The prefix length of the external IPv6 range."', args=[d.arg(name='externalIpv6PrefixLength', type=d.T.string)]),
        withExternalIpv6PrefixLength(externalIpv6PrefixLength): { externalIpv6PrefixLength: externalIpv6PrefixLength },
        '#withName':: d.fn(help='"Immutable. The name of this access configuration. In ipv6AccessConfigs, the recommended name is External IPv6."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      withName(name): { name: name },
      '#withNetworkIp':: d.fn(help='"DEPRECATED. Although this field is still available, there is limited support. We recommend that you use `spec.networkInterface.networkIpRef` instead."', args=[d.arg(name='networkIp', type=d.T.string)]),
    ...
    '#params':: d.obj(help='"Immutable. Stores additional params passed with the request, but not persisted as part of resource payload."'),
    params: {
      '#withResourceManagerTags':: d.fn(help='"Immutable. A map of resource manager tags. Resource manager tag keys and values have the same definition as resource manager tags. Keys must be in the format tagKeys/{tag_key_id}, and values are in the format tagValues/456. The field is ignored (both PUT & PATCH) when empty."', args=[d.arg(name='resourceManagerTags', type=d.T.object)]),
      withResourceManagerTags(resourceManagerTags): { spec+: { params+: { resourceManagerTags: resourceManagerTags } } },
      '#withResourceManagerTagsMixin':: d.fn(help='"Immutable. A map of resource manager tags. Resource manager tag keys and values have the same definition as resource manager tags. Keys must be in the format tagKeys/{tag_key_id}, and values are in the format tagValues/456. The field is ignored (both PUT & PATCH) when empty."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='resourceManagerTags', type=d.T.object)]),
      withResourceManagerTagsMixin(resourceManagerTags): { spec+: { params+: { resourceManagerTags+: resourceManagerTags } } },
    },
    ...
    scheduling: {
      '#localSsdRecoveryTimeout':: d.obj(help='"Immutable. Specifies the maximum amount of time a Local Ssd Vm should wait while\\n  recovery of the Local Ssd state is attempted. Its value should be in\\n  between 0 and 168 hours with hour granularity and the default value being 1\\n  hour."'),
      localSsdRecoveryTimeout: {
        ...
        withNanos(nanos): { spec+: { scheduling+: { localSsdRecoveryTimeout+: { nanos: nanos } } } },
        ...
        withSeconds(seconds): { spec+: { scheduling+: { localSsdRecoveryTimeout+: { seconds: seconds } } } },
      },
      ...
      '#withInstanceTerminationAction':: d.fn(help='"Specifies the action GCE should take when SPOT VM is preempted."', args=[d.arg(name='instanceTerminationAction', type=d.T.string)]),
    ...
    scratchDisk: {
      ...
      '#withSize':: d.fn(help='"Immutable. The size of the disk in gigabytes. One of 375 or 3000."', args=[d.arg(name='size', type=d.T.integer)]),
