{
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#asyncPrimaryDisk':: d.obj(help='"Immutable. A nested object resource."'),
    asyncPrimaryDisk: {
      '#diskRef':: d.obj(help='"Immutable. Primary disk for asynchronous disk replication."'),
      diskRef: {
        ...
        withExternal(external): { spec+: { asyncPrimaryDisk+: { diskRef+: { external: external } } } },
        '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { asyncPrimaryDisk+: { diskRef+: { name: name } } } },
        ...
        withNamespace(namespace): { spec+: { asyncPrimaryDisk+: { diskRef+: { namespace: namespace } } } },
      },
    },
    ...
    diskEncryptionKey: {
      ...
      '#rsaEncryptedKey':: d.obj(help='"Immutable. Specifies an RFC 4648 base64 encoded, RSA-wrapped 2048-bit\\ncustomer-supplied encryption key to either encrypt or decrypt\\nthis resource. You can provide either the rawKey or the rsaEncryptedKey."'),
      rsaEncryptedKey: {
        '#valueFrom':: d.obj(help="\"Source for the field's value. Cannot be used if 'value' is specified.\""),
        valueFrom: {
          '#secretKeyRef':: d.obj(help="\"Reference to a value with the given key in the given Secret in the resource's namespace.\""),
          secretKeyRef: {
            '#withKey':: d.fn(help='"Key that identifies the value to be extracted."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { spec+: { diskEncryptionKey+: { rsaEncryptedKey+: { valueFrom+: { secretKeyRef+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the Secret to extract a value from."', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { diskEncryptionKey+: { rsaEncryptedKey+: { valueFrom+: { secretKeyRef+: { name: name } } } } } },
          },
        },
        '#withValue':: d.fn(help="\"Value of the field. Cannot be used if 'valueFrom' is specified.\"", args=[d.arg(name='value', type=d.T.string)]),
        withValue(value): { spec+: { diskEncryptionKey+: { rsaEncryptedKey+: { value: value } } } },
      },
    ...
    '#sourceDiskRef':: d.obj(help='"The source disk used to create this disk."'),
    sourceDiskRef: {
      '#withExternal':: d.fn(help='"Allowed value: The `selfLink` field of a `ComputeDisk` resource."', args=[d.arg(name='external', type=d.T.string)]),
      withExternal(external): { spec+: { sourceDiskRef+: { external: external } } },
      '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { sourceDiskRef+: { name: name } } },
      '#withNamespace':: d.fn(help='"Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/"', args=[d.arg(name='namespace', type=d.T.string)]),
      withNamespace(namespace): { spec+: { sourceDiskRef+: { namespace: namespace } } },
    },
    ...
    '#withEnableConfidentialCompute':: d.fn(help='"Immutable. Whether this disk is using confidential compute mode.\\nNote: Only supported on hyperdisk skus, disk_encryption_key is required when setting to true."', args=[d.arg(name='enableConfidentialCompute', type=d.T.boolean)]),
    withEnableConfidentialCompute(enableConfidentialCompute): { spec+: { enableConfidentialCompute: enableConfidentialCompute } },
    '#withGuestOsFeatures':: d.fn(help='"Immutable. A list of features to enable on the guest operating system.\\nApplicable only for bootable disks."', args=[d.arg(name='guestOsFeatures', type=d.T.array)]),
    ...
    '#withProvisionedIops':: d.fn(help="\"Indicates how many IOPS must be provisioned for the disk.\\nNote: Updating currently is only supported by hyperdisk skus without the need to delete and recreate the disk, hyperdisk\\nallows for an update of IOPS every 4 hours. To update your hyperdisk more frequently, you'll need to manually delete and recreate it.\"", args=[d.arg(name='provisionedIops', type=d.T.integer)]),
    withProvisionedIops(provisionedIops): { spec+: { provisionedIops: provisionedIops } },
    '#withProvisionedThroughput':: d.fn(help="\"Indicates how much Throughput must be provisioned for the disk.\\nNote: Updating currently is only supported by hyperdisk skus without the need to delete and recreate the disk, hyperdisk\\nallows for an update of Throughput every 4 hours. To update your hyperdisk more frequently, you'll need to manually delete and recreate it.\"", args=[d.arg(name='provisionedThroughput', type=d.T.integer)]),
    withProvisionedThroughput(provisionedThroughput): { spec+: { provisionedThroughput: provisionedThroughput } },
