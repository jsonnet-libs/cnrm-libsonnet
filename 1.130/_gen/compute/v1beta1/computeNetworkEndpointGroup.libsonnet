{
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#networkRef':: d.obj(help='"The network to which all network endpoints in the NEG belong. Uses\\n\\"default\\" project network if unspecified."'),
    networkRef: {
    ...
    '#subnetworkRef':: d.obj(help='"Optional subnetwork to which all network endpoints in the NEG belong."'),
    subnetworkRef: {
    ...
    '#withDefaultPort':: d.fn(help='"Immutable. The default port used if the port number is not specified in the\\nnetwork endpoint."', args=[d.arg(name='defaultPort', type=d.T.integer)]),
    withDefaultPort(defaultPort): { spec+: { defaultPort: defaultPort } },
    ...
    '#withLocation':: d.fn(help='"Location represents the geographical location of the ComputeNetworkEndpointGroup. Specify a zone name. Reference: GCP definition of regions/zones (https://cloud.google.com/compute/docs/regions-zones/)"', args=[d.arg(name='location', type=d.T.string)]),
    withLocation(location): { spec+: { location: location } },
    '#withNetworkEndpointType':: d.fn(help='"Immutable. Type of network endpoints in this network endpoint group.\\nNON_GCP_PRIVATE_IP_PORT is used for hybrid connectivity network\\nendpoint groups (see https://cloud.google.com/load-balancing/docs/hybrid).\\nNote that NON_GCP_PRIVATE_IP_PORT can only be used with Backend Services\\nthat 1) have the following load balancing schemes: EXTERNAL, EXTERNAL_MANAGED,\\nINTERNAL_MANAGED, and INTERNAL_SELF_MANAGED and 2) support the RATE or\\nCONNECTION balancing modes.\\n\\nPossible values include: GCE_VM_IP, GCE_VM_IP_PORT, and NON_GCP_PRIVATE_IP_PORT. Default value: \\"GCE_VM_IP_PORT\\" Possible values: [\\"GCE_VM_IP\\", \\"GCE_VM_IP_PORT\\", \\"NON_GCP_PRIVATE_IP_PORT\\"]."', args=[d.arg(name='networkEndpointType', type=d.T.string)]),
