{
  ...
  spec: {
    ...
    cloudFunction: {
      '#functionRef':: d.obj(help='"Immutable. A user-defined name of the Cloud Function.\\nThe function name is case-sensitive and must be 1-63 characters long.\\nExample value: \\"func1\\"."'),
      functionRef: {
    ...
    cloudRun: {
      '#serviceRef':: d.obj(help='"Immutable. Cloud Run service is the main resource of Cloud Run.\\nThe service must be 1-63 characters long, and comply with RFC1035.\\nExample value: \\"run-service\\"."'),
      serviceRef: {
