{
  ...
  '#':: d.pkg(name='computeNetworkFirewallPolicy', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of ComputeNetworkFirewallPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
