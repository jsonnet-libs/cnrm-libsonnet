{
  ...
  '#':: d.pkg(name='computeNetworkFirewallPolicyAssociation', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of ComputeNetworkFirewallPolicyAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#attachmentTargetRef':: d.obj(help='"The target that the firewall policy is attached to."'),
    attachmentTargetRef: {
    ...
    '#firewallPolicyRef':: d.obj(help='"The firewall policy ID of the association."'),
    firewallPolicyRef: {
