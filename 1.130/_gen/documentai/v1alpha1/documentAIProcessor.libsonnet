{
  ...
  '#':: d.pkg(name='documentAIProcessor', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of DocumentAIProcessor', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withDisplayName':: d.fn(help='"Immutable. The display name. Must be unique."', args=[d.arg(name='displayName', type=d.T.string)]),
    withDisplayName(displayName): { spec+: { displayName: displayName } },
    '#withKmsKeyName':: d.fn(help='"Immutable. The KMS key used for encryption/decryption in CMEK scenarios. See https://cloud.google.com/security-key-management."', args=[d.arg(name='kmsKeyName', type=d.T.string)]),
    ...
    '#withType':: d.fn(help='"Immutable. The type of processor. For possible types see the [official list](https://cloud.google.com/document-ai/docs/reference/rest/v1/projects.locations/fetchProcessorTypes#google.cloud.documentai.v1.DocumentProcessorService.FetchProcessorTypes)."', args=[d.arg(name='type', type=d.T.string)]),
