{
  ...
  spec: {
    ...
    '#withType':: d.fn(help='"The type of the schema definition Default value: \\"TYPE_UNSPECIFIED\\" Possible values: [\\"TYPE_UNSPECIFIED\\", \\"PROTOCOL_BUFFER\\", \\"AVRO\\"]."', args=[d.arg(name='type', type=d.T.string)]),
