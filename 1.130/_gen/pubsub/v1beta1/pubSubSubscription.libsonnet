{
  ...
  spec: {
    ...
    bigqueryConfig: {
      '#tableRef':: d.obj(help='"The name of the table to which to write data."'),
      tableRef: {
        '#withExternal':: d.fn(help='"Allowed value: string of the format `{{project}}.{{dataset_id}}.{{value}}`, where {{value}} is the `name` field of a `BigQueryTable` resource."', args=[d.arg(name='external', type=d.T.string)]),
        withExternal(external): { spec+: { bigqueryConfig+: { tableRef+: { external: external } } } },
        '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { bigqueryConfig+: { tableRef+: { name: name } } } },
        ...
        withNamespace(namespace): { spec+: { bigqueryConfig+: { tableRef+: { namespace: namespace } } } },
      },
      '#withDropUnknownFields':: d.fn(help="\"When true and useTopicSchema is true, any fields that are a part of the topic schema that are not part of the BigQuery table schema are dropped when writing to BigQuery.\\nOtherwise, the schemas must be kept in sync and any messages with extra fields are not written and remain in the subscription's backlog.\"", args=[d.arg(name='dropUnknownFields', type=d.T.boolean)]),
      withDropUnknownFields(dropUnknownFields): { spec+: { bigqueryConfig+: { dropUnknownFields: dropUnknownFields } } },
      '#withUseTopicSchema':: d.fn(help="\"When true, use the topic's schema as the columns to write to in BigQuery, if it exists.\"", args=[d.arg(name='useTopicSchema', type=d.T.boolean)]),
      withUseTopicSchema(useTopicSchema): { spec+: { bigqueryConfig+: { useTopicSchema: useTopicSchema } } },
      ...
      withWriteMetadata(writeMetadata): { spec+: { bigqueryConfig+: { writeMetadata: writeMetadata } } },
    },
    ...
    cloudStorageConfig: {
      ...
      avroConfig: {
        '#withWriteMetadata':: d.fn(help='"When true, write the subscription name, messageId, publishTime, attributes, and orderingKey as additional fields in the output."', args=[d.arg(name='writeMetadata', type=d.T.boolean)]),
        withWriteMetadata(writeMetadata): { spec+: { cloudStorageConfig+: { avroConfig+: { writeMetadata: writeMetadata } } } },
      },
      '#bucketRef':: d.obj(help='"User-provided name for the Cloud Storage bucket. The bucket must be created by the user. The bucket name must be without any prefix like \\"gs://\\"."'),
      bucketRef: {
        '#withExternal':: d.fn(help='"Allowed value: The `name` field of a `StorageBucket` resource."', args=[d.arg(name='external', type=d.T.string)]),
        withExternal(external): { spec+: { cloudStorageConfig+: { bucketRef+: { external: external } } } },
        '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { cloudStorageConfig+: { bucketRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/"', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { cloudStorageConfig+: { bucketRef+: { namespace: namespace } } } },
      },
      ...
      withFilenamePrefix(filenamePrefix): { spec+: { cloudStorageConfig+: { filenamePrefix: filenamePrefix } } },
      ...
      withFilenameSuffix(filenameSuffix): { spec+: { cloudStorageConfig+: { filenameSuffix: filenameSuffix } } },
      '#withMaxBytes':: d.fn(help='"The maximum bytes that can be written to a Cloud Storage file before a new file is created. Min 1 KB, max 10 GiB.\\nThe maxBytes limit may be exceeded in cases where messages are larger than the limit."', args=[d.arg(name='maxBytes', type=d.T.integer)]),
      withMaxBytes(maxBytes): { spec+: { cloudStorageConfig+: { maxBytes: maxBytes } } },
      ...
      withMaxDuration(maxDuration): { spec+: { cloudStorageConfig+: { maxDuration: maxDuration } } },
      '#withState':: d.fn(help='"An output-only field that indicates whether or not the subscription can receive messages."', args=[d.arg(name='state', type=d.T.string)]),
      withState(state): { spec+: { cloudStorageConfig+: { state: state } } },
    },
    ...
    pushConfig: {
      ...
      noWrapper: {
        ...
        withWriteMetadata(writeMetadata): { spec+: { pushConfig+: { noWrapper+: { writeMetadata: writeMetadata } } } },
      },
    ...
    '#withEnableExactlyOnceDelivery':: d.fn(help="\"If 'true', Pub/Sub provides the following guarantees for the delivery\\nof a message with a given value of messageId on this Subscriptions':\\n\\n- The message sent to a subscriber is guaranteed not to be resent before the message's acknowledgement deadline expires.\\n\\n- An acknowledged message will not be resent to a subscriber.\\n\\nNote that subscribers may still receive multiple copies of a message when 'enable_exactly_once_delivery'\\nis true if the message was published multiple times by a publisher client. These copies are considered distinct by Pub/Sub and have distinct messageId values.\"", args=[d.arg(name='enableExactlyOnceDelivery', type=d.T.boolean)]),
    withEnableExactlyOnceDelivery(enableExactlyOnceDelivery): { spec+: { enableExactlyOnceDelivery: enableExactlyOnceDelivery } },
