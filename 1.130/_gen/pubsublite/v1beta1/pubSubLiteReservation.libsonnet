{
  ...
  '#':: d.pkg(name='pubSubLiteReservation', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of PubSubLiteReservation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withRegion':: d.fn(help='"The region of the pubsub lite reservation."', args=[d.arg(name='region', type=d.T.string)]),
    ...
    '#withThroughputCapacity':: d.fn(help='"The reserved throughput capacity. Every unit of throughput capacity is\\nequivalent to 1 MiB/s of published messages or 2 MiB/s of subscribed\\nmessages."', args=[d.arg(name='throughputCapacity', type=d.T.integer)]),
    withThroughputCapacity(throughputCapacity): { spec+: { throughputCapacity: throughputCapacity } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
