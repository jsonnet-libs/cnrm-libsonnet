{
  ...
  '#':: d.pkg(name='storageTransferAgentPool', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of StorageTransferAgentPool', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#bandwidthLimit':: d.obj(help="\"Specifies the bandwidth limit details. If this field is unspecified, the default value is set as 'No Limit'.\""),
    bandwidthLimit: {
      '#withLimitMbps':: d.fn(help='"Bandwidth rate in megabytes per second, distributed across all the agents in the pool."', args=[d.arg(name='limitMbps', type=d.T.string)]),
      withLimitMbps(limitMbps): { spec+: { bandwidthLimit+: { limitMbps: limitMbps } } },
    },
    ...
    '#withDisplayName':: d.fn(help='"Specifies the client-specified AgentPool description."', args=[d.arg(name='displayName', type=d.T.string)]),
