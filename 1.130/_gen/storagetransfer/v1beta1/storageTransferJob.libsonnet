{
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#notificationConfig':: d.obj(help='"Notification configuration."'),
    notificationConfig: {
      '#topicRef':: d.obj(help='"The PubSubTopic to which to publish notifications."'),
      topicRef: {
        ...
        withExternal(external): { spec+: { notificationConfig+: { topicRef+: { external: external } } } },
        '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { notificationConfig+: { topicRef+: { name: name } } } },
        ...
        withNamespace(namespace): { spec+: { notificationConfig+: { topicRef+: { namespace: namespace } } } },
      },
      '#withEventTypes':: d.fn(help='"Event types for which a notification is desired. If empty, send notifications for all event types. The valid types are \\"TRANSFER_OPERATION_SUCCESS\\", \\"TRANSFER_OPERATION_FAILED\\", \\"TRANSFER_OPERATION_ABORTED\\"."', args=[d.arg(name='eventTypes', type=d.T.array)]),
      withEventTypes(eventTypes): { spec+: { notificationConfig+: { eventTypes: if std.isArray(v=eventTypes) then eventTypes else [eventTypes] } } },
      '#withEventTypesMixin':: d.fn(help='"Event types for which a notification is desired. If empty, send notifications for all event types. The valid types are \\"TRANSFER_OPERATION_SUCCESS\\", \\"TRANSFER_OPERATION_FAILED\\", \\"TRANSFER_OPERATION_ABORTED\\"."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='eventTypes', type=d.T.array)]),
      withEventTypesMixin(eventTypes): { spec+: { notificationConfig+: { eventTypes+: if std.isArray(v=eventTypes) then eventTypes else [eventTypes] } } },
      '#withPayloadFormat':: d.fn(help='"The desired format of the notification message payloads. One of \\"NONE\\" or \\"JSON\\"."', args=[d.arg(name='payloadFormat', type=d.T.string)]),
      withPayloadFormat(payloadFormat): { spec+: { notificationConfig+: { payloadFormat: payloadFormat } } },
    },
    ...
    schedule: {
      ...
      '#withRepeatInterval':: d.fn(help="\"Interval between the start of each scheduled transfer. If unspecified, the default value is 24 hours. This value may not be less than 1 hour. A duration in seconds with up to nine fractional digits, terminated by 's'. Example: \\\"3.5s\\\".\"", args=[d.arg(name='repeatInterval', type=d.T.string)]),
      withRepeatInterval(repeatInterval): { spec+: { schedule+: { repeatInterval: repeatInterval } } },
    },
    ...
    transferSpec: {
      ...
      awsS3DataSource: {
        ...
        '#withPath':: d.fn(help='"S3 Bucket path in bucket to transfer."', args=[d.arg(name='path', type=d.T.string)]),
        withPath(path): { spec+: { transferSpec+: { awsS3DataSource+: { path: path } } } },
        '#withRoleArn':: d.fn(help="\"The Amazon Resource Name (ARN) of the role to support temporary credentials via 'AssumeRoleWithWebIdentity'. For more information about ARNs, see [IAM ARNs](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_identifiers.html#identifiers-arns). When a role ARN is provided, Transfer Service fetches temporary credentials for the session using a 'AssumeRoleWithWebIdentity' call for the provided role using the [GoogleServiceAccount][] for this project.\"", args=[d.arg(name='roleArn', type=d.T.string)]),
        withRoleArn(roleArn): { spec+: { transferSpec+: { awsS3DataSource+: { roleArn: roleArn } } } },
      },
      ...
      objectConditions: {
        ...
        '#withLastModifiedBefore':: d.fn(help="\"If specified, only objects with a \\\"last modification time\\\" before this timestamp and objects that don't have a \\\"last modification time\\\" are transferred. A timestamp in RFC3339 UTC \\\"Zulu\\\" format, with nanosecond resolution and up to nine fractional digits. Examples: \\\"2014-10-02T15:01:23Z\\\" and \\\"2014-10-02T15:01:23.045123456Z\\\".\"", args=[d.arg(name='lastModifiedBefore', type=d.T.string)]),
        withLastModifiedBefore(lastModifiedBefore): { spec+: { transferSpec+: { objectConditions+: { lastModifiedBefore: lastModifiedBefore } } } },
        '#withLastModifiedSince':: d.fn(help="\"If specified, only objects with a \\\"last modification time\\\" on or after this timestamp and objects that don't have a \\\"last modification time\\\" are transferred. A timestamp in RFC3339 UTC \\\"Zulu\\\" format, with nanosecond resolution and up to nine fractional digits. Examples: \\\"2014-10-02T15:01:23Z\\\" and \\\"2014-10-02T15:01:23.045123456Z\\\".\"", args=[d.arg(name='lastModifiedSince', type=d.T.string)]),
        withLastModifiedSince(lastModifiedSince): { spec+: { transferSpec+: { objectConditions+: { lastModifiedSince: lastModifiedSince } } } },
      ...
      '#posixDataSink':: d.obj(help='"A POSIX filesystem data sink."'),
      posixDataSink: {
        '#withRootDirectory':: d.fn(help='"Root directory path to the filesystem."', args=[d.arg(name='rootDirectory', type=d.T.string)]),
        withRootDirectory(rootDirectory): { spec+: { transferSpec+: { posixDataSink+: { rootDirectory: rootDirectory } } } },
      },
      '#posixDataSource':: d.obj(help='"A POSIX filesystem data source."'),
      posixDataSource: {
        '#withRootDirectory':: d.fn(help='"Root directory path to the filesystem."', args=[d.arg(name='rootDirectory', type=d.T.string)]),
        withRootDirectory(rootDirectory): { spec+: { transferSpec+: { posixDataSource+: { rootDirectory: rootDirectory } } } },
      },
      ...
      transferOptions: {
        ...
        '#withOverwriteWhen':: d.fn(help='"When to overwrite objects that already exist in the sink. If not set, overwrite behavior is determined by overwriteObjectsAlreadyExistingInSink."', args=[d.arg(name='overwriteWhen', type=d.T.string)]),
        withOverwriteWhen(overwriteWhen): { spec+: { transferSpec+: { transferOptions+: { overwriteWhen: overwriteWhen } } } },
      },
      '#withSinkAgentPoolName':: d.fn(help='"Immutable. Specifies the agent pool name associated with the posix data source. When unspecified, the default name is used."', args=[d.arg(name='sinkAgentPoolName', type=d.T.string)]),
      withSinkAgentPoolName(sinkAgentPoolName): { spec+: { transferSpec+: { sinkAgentPoolName: sinkAgentPoolName } } },
      '#withSourceAgentPoolName':: d.fn(help='"Immutable. Specifies the agent pool name associated with the posix data source. When unspecified, the default name is used."', args=[d.arg(name='sourceAgentPoolName', type=d.T.string)]),
      withSourceAgentPoolName(sourceAgentPoolName): { spec+: { transferSpec+: { sourceAgentPoolName: sourceAgentPoolName } } },
    },
