{
  ...
  spec: {
    ...
    gitFileSource: {
      ...
      '#withRepoType':: d.fn(help='"The type of the repo, since it may not be explicit from the repo field (e.g from a URL). \\nValues can be UNKNOWN, CLOUD_SOURCE_REPOSITORIES, GITHUB Possible values: [\\"UNKNOWN\\", \\"CLOUD_SOURCE_REPOSITORIES\\", \\"GITHUB\\"]."', args=[d.arg(name='repoType', type=d.T.string)]),
