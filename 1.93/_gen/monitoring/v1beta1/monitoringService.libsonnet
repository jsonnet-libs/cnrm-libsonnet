{
  ...
  '#':: d.pkg(name='monitoringService', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of MonitoringService', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#telemetry':: d.obj(help='"Configuration for how to query telemetry on a Service."'),
    telemetry: {
      '#withResourceName':: d.fn(help='"The full name of the resource that defines this service. Formatted as described in https://cloud.google.com/apis/design/resource_names."', args=[d.arg(name='resourceName', type=d.T.string)]),
      withResourceName(resourceName): { spec+: { telemetry+: { resourceName: resourceName } } },
    },
    '#withDisplayName':: d.fn(help='"Name used for UI elements listing this Service."', args=[d.arg(name='displayName', type=d.T.string)]),
