{
  ...
  spec: {
    ...
    rules: {
      ...
      matches: {
        ...
        method: {
          ...
          '#withType':: d.fn(help='"Optional. Specifies how to match against the name. If not specified, a default value of \\"EXACT\\" is used. Possible values: MATCH_TYPE_UNSPECIFIED, MATCH_ANY, MATCH_ALL"', args=[d.arg(name='type', type=d.T.string)]),
    ...
    '#withLabels':: d.fn(help='"Optional. Set of label tags associated with the GrpcRoute resource."', args=[d.arg(name='labels', type=d.T.object)]),
    withLabels(labels): { spec+: { labels: labels } },
    '#withLabelsMixin':: d.fn(help='"Optional. Set of label tags associated with the GrpcRoute resource."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
    ...
    '#withRouters':: d.fn(help='"Optional. Routers define a list of routers this GrpcRoute should be served by. Each router reference should match the pattern: `projects/*/locations/global/routers/`"', args=[d.arg(name='routers', type=d.T.array)]),
    withRouters(routers): { spec+: { routers: if std.isArray(v=routers) then routers else [routers] } },
    '#withRoutersMixin':: d.fn(help='"Optional. Routers define a list of routers this GrpcRoute should be served by. Each router reference should match the pattern: `projects/*/locations/global/routers/`"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='routers', type=d.T.array)]),
