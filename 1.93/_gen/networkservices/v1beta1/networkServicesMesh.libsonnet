{
  ...
  '#':: d.pkg(name='networkServicesMesh', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of NetworkServicesMesh', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withInterceptionPort':: d.fn(help="\"Optional. If set to a valid TCP port (1-65535), instructs the SIDECAR proxy to listen on the specified port of localhost (127.0.0.1) address. The SIDECAR proxy will expect all traffic to be redirected to this port regardless of its actual ip:port destination. If unset, a port '15001' is used as the interception port. This field is only valid if the type of Mesh is SIDECAR.\"", args=[d.arg(name='interceptionPort', type=d.T.integer)]),
    withInterceptionPort(interceptionPort): { spec+: { interceptionPort: interceptionPort } },
    '#withLabels':: d.fn(help='"Optional. Set of label tags associated with the Mesh resource."', args=[d.arg(name='labels', type=d.T.object)]),
    withLabels(labels): { spec+: { labels: labels } },
    '#withLabelsMixin':: d.fn(help='"Optional. Set of label tags associated with the Mesh resource."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
