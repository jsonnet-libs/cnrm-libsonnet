{
  ...
  '#':: d.pkg(name='pubSubSchema', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of PubSubSchema', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withDefinition':: d.fn(help='"Immutable. The definition of the schema.\\nThis should contain a string representing the full definition of the schema\\nthat is a valid schema definition of the type specified in type."', args=[d.arg(name='definition', type=d.T.string)]),
    ...
    '#withType':: d.fn(help='"Immutable. The type of the schema definition Default value: \\"TYPE_UNSPECIFIED\\" Possible values: [\\"TYPE_UNSPECIFIED\\", \\"PROTOCOL_BUFFER\\", \\"AVRO\\"]."', args=[d.arg(name='type', type=d.T.string)]),
