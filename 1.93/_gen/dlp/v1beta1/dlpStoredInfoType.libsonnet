{
  ...
  '#':: d.pkg(name='dlpStoredInfoType', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of DLPStoredInfoType', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#dictionary':: d.obj(help='"Store dictionary-based CustomInfoType."'),
    dictionary: {
      ...
      cloudStoragePath: {
        ...
        withPath(path): { spec+: { dictionary+: { cloudStoragePath+: { path: path } } } },
      },
      ...
      wordList: {
        ...
        withWords(words): { spec+: { dictionary+: { wordList+: { words: if std.isArray(v=words) then words else [words] } } } },
        ...
        withWordsMixin(words): { spec+: { dictionary+: { wordList+: { words+: if std.isArray(v=words) then words else [words] } } } },
      },
    },
    '#largeCustomDictionary':: d.obj(help='"StoredInfoType where findings are defined by a dictionary of phrases."'),
    largeCustomDictionary: {
      ...
      bigQueryField: {
        ...
        field: {
          ...
          withName(name): { spec+: { largeCustomDictionary+: { bigQueryField+: { field+: { name: name } } } } },
        },
        '#table':: d.obj(help='"Source table of the field."'),
        table: {
          ...
          datasetRef: {
            ...
            withExternal(external): { spec+: { largeCustomDictionary+: { bigQueryField+: { table+: { datasetRef+: { external: external } } } } } },
            '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { largeCustomDictionary+: { bigQueryField+: { table+: { datasetRef+: { name: name } } } } } },
            ...
            withNamespace(namespace): { spec+: { largeCustomDictionary+: { bigQueryField+: { table+: { datasetRef+: { namespace: namespace } } } } } },
          },
          ...
          projectRef: {
            ...
            withExternal(external): { spec+: { largeCustomDictionary+: { bigQueryField+: { table+: { projectRef+: { external: external } } } } } },
            '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { largeCustomDictionary+: { bigQueryField+: { table+: { projectRef+: { name: name } } } } } },
            '#withNamespace':: d.fn(help='"Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/"', args=[d.arg(name='namespace', type=d.T.string)]),
            withNamespace(namespace): { spec+: { largeCustomDictionary+: { bigQueryField+: { table+: { projectRef+: { namespace: namespace } } } } } },
          },
          '#tableRef':: d.obj(help=''),
          tableRef: {
            ...
            withExternal(external): { spec+: { largeCustomDictionary+: { bigQueryField+: { table+: { tableRef+: { external: external } } } } } },
            '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { largeCustomDictionary+: { bigQueryField+: { table+: { tableRef+: { name: name } } } } } },
            '#withNamespace':: d.fn(help='"Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/"', args=[d.arg(name='namespace', type=d.T.string)]),
            withNamespace(namespace): { spec+: { largeCustomDictionary+: { bigQueryField+: { table+: { tableRef+: { namespace: namespace } } } } } },
          },
        },
      },
      '#cloudStorageFileSet':: d.obj(help='"Set of files containing newline-delimited lists of dictionary phrases."'),
      cloudStorageFileSet: {
        '#withUrl':: d.fn(help='"The url, in the format `gs:///`. Trailing wildcard in the path is allowed."', args=[d.arg(name='url', type=d.T.string)]),
        withUrl(url): { spec+: { largeCustomDictionary+: { cloudStorageFileSet+: { url: url } } } },
      },
      '#outputPath':: d.obj(help='"Location to store dictionary artifacts in Google Cloud Storage. These files will only be accessible by project owners and the DLP API. If any of these artifacts are modified, the dictionary is considered invalid and can no longer be used."'),
      outputPath: {
        '#withPath':: d.fn(help='"A url representing a file or path (no wildcards) in Cloud Storage. Example: gs://[BUCKET_NAME]/dictionary.txt"', args=[d.arg(name='path', type=d.T.string)]),
        withPath(path): { spec+: { largeCustomDictionary+: { outputPath+: { path: path } } } },
      },
    },
    ...
    '#regex':: d.obj(help='"Store regular expression-based StoredInfoType."'),
    regex: {
      ...
      withGroupIndexes(groupIndexes): { spec+: { regex+: { groupIndexes: if std.isArray(v=groupIndexes) then groupIndexes else [groupIndexes] } } },
      ...
      withGroupIndexesMixin(groupIndexes): { spec+: { regex+: { groupIndexes+: if std.isArray(v=groupIndexes) then groupIndexes else [groupIndexes] } } },
      ...
      withPattern(pattern): { spec+: { regex+: { pattern: pattern } } },
    },
    '#withDescription':: d.fn(help='"Description of the StoredInfoType (max 256 characters)."', args=[d.arg(name='description', type=d.T.string)]),
    withDescription(description): { spec+: { description: description } },
    '#withDisplayName':: d.fn(help='"Display name of the StoredInfoType (max 256 characters)."', args=[d.arg(name='displayName', type=d.T.string)]),
