{
  ...
  '#':: d.pkg(name='computeFirewallPolicyAssociation', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of ComputeFirewallPolicyAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    attachmentTargetRef: {
      ...
      withName(name): { spec+: { attachmentTargetRef+: { name: name } } },
