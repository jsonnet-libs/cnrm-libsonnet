{
  ...
  spec: {
    ...
    topics: {
      '#topicRef':: d.obj(help='"A list of up to 10 Pub/Sub topics to which messages are\\npublished when control plane operations are called on the secret\\nor its versions."'),
      topicRef: {
    ...
    '#withTopics':: d.fn(help='"A list of up to 10 Pub/Sub topics to which messages are published when control plane operations are called on the secret or its versions."', args=[d.arg(name='topics', type=d.T.array)]),
