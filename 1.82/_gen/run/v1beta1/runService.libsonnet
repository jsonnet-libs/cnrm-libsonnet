    ...
    template: {
      ...
      volumes: {
        ...
        cloudSqlInstance: {
          ...
          '#withConnections':: d.fn(help='', args=[d.arg(name='connections', type=d.T.array)]),
          withConnections(connections): { cloudSqlInstance+: { connections: if std.isArray(v=connections) then connections else [connections] } },
          '#withConnectionsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='connections', type=d.T.array)]),
          withConnectionsMixin(connections): { cloudSqlInstance+: { connections+: if std.isArray(v=connections) then connections else [connections] } },
        },
