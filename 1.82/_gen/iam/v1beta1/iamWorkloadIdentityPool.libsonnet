{
  ...
  '#':: d.pkg(name='iamWorkloadIdentityPool', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of IAMWorkloadIdentityPool', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withDescription':: d.fn(help='"A description of the pool. Cannot exceed 256 characters."', args=[d.arg(name='description', type=d.T.string)]),
    ...
    '#withDisplayName':: d.fn(help='"A display name for the pool. Cannot exceed 32 characters."', args=[d.arg(name='displayName', type=d.T.string)]),
