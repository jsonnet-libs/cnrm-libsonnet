{
  ...
  spec: {
    ...
    '#namedPort':: d.obj(help='"The named port configuration."'),
    namedPort: {
      '#withName':: d.fn(help='"The name which the port will be mapped to."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
      '#withPort':: d.fn(help='"The port number to map the name to."', args=[d.arg(name='port', type=d.T.integer)]),
    ...
    '#withDescription':: d.fn(help='"Immutable. An optional textual description of the instance group."', args=[d.arg(name='description', type=d.T.string)]),
    ...
    withNamedPort(namedPort): { spec+: { namedPort: if std.isArray(v=namedPort) then namedPort else [namedPort] } },
    ...
    withNamedPortMixin(namedPort): { spec+: { namedPort+: if std.isArray(v=namedPort) then namedPort else [namedPort] } },
    ...
    '#withZone':: d.fn(help='"Immutable. The zone that this instance group should be created in."', args=[d.arg(name='zone', type=d.T.string)]),
