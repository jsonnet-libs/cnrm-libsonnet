{
  ...
  '#':: d.pkg(name='networkConnectivityHub', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of NetworkConnectivityHub', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withDescription':: d.fn(help='"An optional description of the hub."', args=[d.arg(name='description', type=d.T.string)]),
