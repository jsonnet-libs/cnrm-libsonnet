{
  ...
  spec: {
    ...
    addonsConfig: {
      ...
      '#gcePersistentDiskCsiDriverConfig':: d.obj(help='"Whether this cluster should enable the Google Compute Engine Persistent Disk Container Storage Interface (CSI) Driver. Defaults to enabled; set disabled = true to disable."'),
    ...
    monitoringConfig: {
      ...
      '#withEnableComponents':: d.fn(help='"GKE components exposing metrics. Valid values include SYSTEM_COMPONENTS, APISERVER, CONTROLLER_MANAGER, SCHEDULER, and WORKLOADS."', args=[d.arg(name='enableComponents', type=d.T.array)]),
      ...
      '#withEnableComponentsMixin':: d.fn(help='"GKE components exposing metrics. Valid values include SYSTEM_COMPONENTS, APISERVER, CONTROLLER_MANAGER, SCHEDULER, and WORKLOADS."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='enableComponents', type=d.T.array)]),
    ...
    privateClusterConfig: {
      ...
      '#withEnablePrivateEndpoint':: d.fn(help="\"When true, the cluster's private endpoint is used as the cluster endpoint and access through the public endpoint is disabled. When false, either endpoint can be used. This field only applies to private clusters, when enable_private_nodes is true.\"", args=[d.arg(name='enablePrivateEndpoint', type=d.T.boolean)]),
