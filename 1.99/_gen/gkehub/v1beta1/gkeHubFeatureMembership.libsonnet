{
  ...
  spec: {
    ...
    configmanagement: {
      ...
      configSync: {
        ...
        oci: {
          '#gcpServiceAccountRef':: d.obj(help=''),
          gcpServiceAccountRef: {
            '#withExternal':: d.fn(help='"The GCP Service Account Email used for auth when secret_type is gcpserviceaccount. \\n\\nAllowed value: The `email` field of an `IAMServiceAccount` resource."', args=[d.arg(name='external', type=d.T.string)]),
    ...
    mesh: {
      '#withControlPlane':: d.fn(help='"Whether to automatically manage Service Mesh control planes. Possible values: CONTROL_PLANE_MANAGEMENT_UNSPECIFIED, AUTOMATIC, MANUAL"', args=[d.arg(name='controlPlane', type=d.T.string)]),
